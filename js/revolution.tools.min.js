...
!(function (a) {
  ...
  var b = a.GreenSockGlobals || a,
    ...
    z =
      ...
      b.SplitText =
        function (a, b) {
          if (("string" == typeof a && (a = z.selector(a)), !a))
    ...
    F = function (a, b, c, d, e, h, j) {
            ...
            (p || S || (R && !Q)) &&
              ...
              P &&
                (((n._isSplit && p) ||
                  ...
                  (q.push(n), (n._x -= x), D(n, a, M) && (n._wordEnd = !0)),
                "BR" === n.nodeName &&
              ...
              !Q && R
                ? n._isSplit
                  ...
                  ? ((n._parent = n.parentNode),
                    ...
                    m--)
                  : p ||
                    ((v = !n.nextSibling && D(n.parentNode, a, M)),
      ...
      if (P) {
        ...
        for (r = " " === M && (!S || (!Q && !R)), k = 0; k < P.length; k++) {
          ...
          0 === m
            ? (t.innerHTML = "&nbsp;")
            : Q || R || (E(t), A(t, String.fromCharCode(160), " ")),
    ...
    G = function (a, b, c, d) {
      ...
      for (
        ...
        if (((q = g.charAt(i)), J && (z = J(g.substr(i), b.specialChars))))
          (q = g.substr(i, z || 1)),
            (h += D && " " !== q ? d() + q + "</" + B + ">" : q),
            (i += z - 1);
          ...
          "{" === q && "{{LT}}" === g.substr(i, 6)
            ? ((h += D ? d() + "{{LT}}</" + B + ">" : "{{LT}}"), (i += 5))
            : (q.charCodeAt(0) >= o && q.charCodeAt(0) <= p) ||
              (g.charCodeAt(i + 1) >= 65024 && g.charCodeAt(i + 1) <= 65039)
            ? ((x = v(g.substr(i, 2))),
              (y = v(g.substr(i + 2, 2))),
              (j =
                (x >= r && s >= x && y >= r && s >= y) || (y >= t && u >= y)
                  ? 4
                  : 2),
              (h +=
                D && " " !== q
