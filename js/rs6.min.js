...
!(function (e, t) {
  ...
  e.fn.extend({
    ...
    getRSVersion: function (e) {
      var t,
        i,
        r = window.SliderRevolutionVersion;
      if (!e) {
        for (var a in ((t = i =
          "---------------------------------------------------------\n"),
        (t += "    Currently Loaded Slider Revolution & SR Modules :\n" + i),
        r))
          r.hasOwnProperty(a) && (t += r[a].alias + ": " + r[a].ver + "\n");
        t += i;
      }
      return e ? r : t;
    },
    revremoveslide: function (t) {
      return this.each(function () {
        var r = this.id;
        if (
          !(t < 0 || t > i[r].slideamount) &&
          i[r] &&
          i[r].slides.length > 0 &&
          (t > 0 || t <= i[r].slides.length)
        ) {
          var a = i.gA(i[r].slides[t], "key");
          (i[r].slideamount = i[r].slideamount - 1),
            (i[r].realslideamount = i[r].realslideamount - 1),
            s("rs-bullet", a, r),
            s("rs-tab", a, r),
            s("rs-thumb", a, r),
            e(i[r].slides[t]).remove(),
            (i[r].slides = o(i[r].slides, t)),
            i[r].carousel &&
              i[r].carousel.slides &&
              (i[r].carousel.slides = o(i[r].carousel.slides, t)),
            (i[r].thumbs = o(i[r].thumbs, t)),
            i.updateNavIndexes && i.updateNavIndexes(r),
            t <= i[r].pr_active_key &&
              (i[r].pr_active_key = i[r].pr_active_key - 1);
        }
      });
    },
    ...
    revkill: function () {
      return this.each(function () {
        ...
        punchgs.TweenMax.killDelayedCallsTo(i.showHideNavElements),
          i[r].c.data("conthover", 1),
          i[r].c.data("conthoverchanged", 1),
          i[r].c.trigger("revolution.slide.onpause");
        var a = i[r].cpar.find("rs-progress");
        i[r].c[0].opt;
        (i[r].tonpause = !0),
          i[r].c.trigger("stoptimer"),
          (i[r].sliderisrunning = !1);
        var o = "resize.revslider-" + i[r].c.attr("id");
        e(window).unbind(o),
          punchgs.TweenMax.killTweensOf(i[r].c.find("*"), !1),
          punchgs.TweenMax.killTweensOf(i[r].c, !1),
          i[r].c.unbind("hover, mouseover, mouseenter,mouseleave, resize"),
          (o = "resize.revslider-" + i[r].c.attr("id")),
          e(window).off(o),
          i[r].c.find("*").each(function () {
            var i = e(this);
            i.unbind(
    ...
    revresume: function () {
      return this.each(function () {
        if (i[this.id] !== t) {
          ...
          r.data("conthover", 0),
            r.data("conthoverchanged", 1),
            r.trigger("revolution.slide.onresume"),
    ...
    revstart: function () {
      ...
      return i[r.id] === t
        ...
        : i[r.id].sliderisrunning
        ? (console.log("Slider Is Running Already"), !1)
        : ((i[r.id].c = e(r)),
          (i[r.id].canvas = i[r.id].c.find("rs-slides")),
          h(r.id),
          !0);
    },
    revnext: function () {
    ...
    e.extend(!0, i, {
      ...
      revModal: function (r, a) {
        if (r !== t && i[r] !== t)
          switch (a.mode) {
            case "show":
              (a.slide = a.slide === t ? "to0" : a.slide),
                i[r].modal.bodyclass !== t &&
                  i[r].modal.bodyclass.length >= 0 &&
                  document.body.classList.add(i[r].modal.bodyclass),
                punchgs.TweenMax.to(i[r].modal.bg, 2, {
                  display: "block",
                  opacity: 1,
                ...
                punchgs.TweenMax.set(i[r].modal.c, {
                  display:
                    "auto" === i[r].sliderLayout ? "inline-block" : "block",
                  opacity: 0,
                }),
                ...
                punchgs.TweenMax.fromTo(
                  ...
                  { opacity: 0 },
                  {
                    ...
                    onComplete: function () {
                      i[r].sliderisrunning
                        ? i.callingNewSlide(r, a.slide)
                        : ("to0" !== a.slide &&
                            (i[r].startWithSlideKey = a.slide),
                          h(r));
                    },
                  }
                ),
            ...
            case "close":
              O(r),
                ...
                i[r].modal.bodyclass !== t &&
                  i[r].modal.bodyclass.length >= 0 &&
                  document.body.classList.remove(i[r].modal.bodyclass),
                punchgs.TweenMax.to(i[r].modal.bg, 2, {
                  display: "none",
                  opacity: 0,
                  ease: punchgs.Power3.easeInOut,
                }),
                punchgs.TweenMax.to(i[r].modal.c, 0.3, {
                  display: "none",
                  delay: 0.5,
                  opacity: 0,
                  onComplete: function () {
            ...
            case "init":
              if (
                ...
                -1 === e.inArray(i[r].modal.alias, window.RS_60_MODALS) &&
                  window.RS_60_MODALS.push(i[r].modal.alias),
                i[r].modal.listener === t)
              ) {
                (i[r].modal.c = e("#" + r + "_modal")),
                  (i[r].modal.bg = e(
                  ...
                  "auto" === i[r].sliderLayout && i[r].modal.cover
                    ? e("body").append(i[r].modal.bg)
                    : i[r].modal.c.append(i[r].modal.bg),
                  (i[r].modal.c[0].className +=
                    "rs-modal-" + i[r].sliderLayout);
                var o = {
                  left:
                    "auto" === i[r].sliderLayout
                      ? "center" === i[r].modal.horizontal
                        ? "50%"
                        : "left" === i[r].modal.horizontal
                        ? "0px"
                        : "auto"
                      : "0px",
                  right:
                  ...
                  top:
                    ...
                    "fullwidth" === i[r].sliderLayout
                      ? "middle" === i[r].modal.vertical
                        ? "50%"
                        : "top" === i[r].modal.vertical
                        ? "0px"
                        : "auto"
                      : "0px",
                  bottom:
                ...
                punchgs.TweenMax.set(
                  ...
                  "fullwidth" === i[r].sliderLayout &&
                    punchgs.TweenMax.set(
                      i[r].modal.c.find("rs-module-wrap"),
                      o
                    ),
                  (!1 !== i[r].modal.cover && "false" !== i[r].modal.cover) ||
                    (i[r].modal.coverColor = "transparent"),
                  punchgs.TweenMax.set(i[r].modal.bg, {
                    display: "none",
                    background: i[r].modal.coverColor,
                    opacity: 0,
                  }),
                  e(document).on(
                    "RS_OPENMODAL_" + i[r].modal.alias,
                    function (e, t) {
                      i.revModal(r, { mode: "show", slide: t });
                    }
                  ),
      ...
      smartConvertDivs: function (e) {
        ...
        if ("string" == typeof e && e.indexOf("#") >= 0) {
          ...
          for (var a in i)
            t =
              "string" == typeof i[a] && "#" === i[a][0]
                ? t + (i[a][1] / i[a][3]) * 100 + "%" + (a < r ? "," : "")
                : t + i[a] + (a < r ? "," : "");
        } else t = e;
        return t;
      },
      ...
      updateVisibleArea: function (r) {
        for (var a in ((i[r].viewPort.visible_area = i.revToResp(
          i[r].viewPort.visible_area,
          i[r].rle,
          "200px"
        )),
        (i[r].viewPort.vaType = new Array(4)),
        i[r].viewPort.visible_area))
          i[r].viewPort.visible_area.hasOwnProperty(a) &&
            (e.isNumeric(i[r].viewPort.visible_area[a]) &&
              (i[r].viewPort.visible_area[a] += "%"),
            i[r].viewPort.visible_area[a] !== t &&
              (i[r].viewPort.vaType[a] =
                i[r].viewPort.visible_area[a].indexOf("%") >= 0 ? "%" : "px"),
            (i[r].viewPort.visible_area[a] = parseInt(
              i[r].viewPort.visible_area[a],
              0
            )),
            (i[r].viewPort.visible_area[a] =
              "%" == i[r].viewPort.vaType[a]
                ? i[r].viewPort.visible_area[a] / 100
                : i[r].viewPort.visible_area[a]));
      },
      ...
      get_browser_version: function () {
        ...
        return (
          r && null != (e = i.match(/version\/([\.\d]+)/i)) && (r[2] = e[1]),
          (r = r ? [r[1], r[2]] : [t, navigator.appVersion, "-?"])[1]
        );
      },
      ...
      getComingSlide: function (r, a) {
        ...
        if (
          ((s = 0),
          i[r].pr_active_slide !== t &&
            i[r].pr_active_slide.hasClass("not-in-nav") &&
            (o = i[r].pr_lastshown_key),
          (a !== t && e.isNumeric(a)) || (a !== t && a.match(/to/g)))
        )
          s =
            1 === a || -1 === a
              ? parseInt(o, 0) + a < 0
                ? i[r].slideamount - 1
                : parseInt(o, 0) + a >= i[r].slideamount
                ? 0
                : parseInt(o, 0) + a
              : (a = e.isNumeric(a) ? a : parseInt(a.split("to")[1], 0)) < 0
              ? 0
              : a > i[r].slideamount - 1
              ? i[r].slideamount - 1
              : a;
          ...
          for (var n in i[r].slides)
            i[r].slides.hasOwnProperty(n) &&
              (s =
                i[r].slides &&
                i[r].slides[n] &&
                i.gA(i[r].slides[n], "key") === a
                  ? n
                  : s);
      ...
      callingNewSlide: function (e, t, r) {
        ...
        (i[e].pr_next_key = a.nindex),
          (i[e].sdir = i[e].pr_next_key < i[e].pr_active_key ? 1 : 0),
          i[e].ctNavElement
            ? (i[e].ctNavElement = !1)
            : i[e].c.trigger("revolution.nextslide.waiting"),
          ((a.aindex === i[e].pr_next_key &&
            a.aindex === i[e].pr_lastshown_key) ||
            (i[e].pr_next_key !== a.aindex && -1 != i[e].pr_next_key)) &&
            C(e, r);
      },
      ...
      setSize: function (r, a) {
        var o,
          s = parseInt(i[r].top_outer || 0) + parseInt(i[r].bottom_outer || 0),
          n =
            "carousel" == i[r].sliderType
              ? parseInt(i[r].carousel.padding_top || 0, 0)
              : 0,
          l =
            "carousel" == i[r].sliderType
              ? parseInt(i[r].carousel.padding_bottom || 0, 0)
              : 0,
          d = 0,
          c = 0,
          p = 0,
        ...
        if (
          ((i[r].minHeight = i[r].minHeight === t ? 0 : i[r].minHeight || 0),
          (i[r].paddings =
            i[r].paddings === t
              ? {
              ...
              : i[r].paddings),
          i[r].rowzones && i[r].rowzones.length > 0)
        ) {
          if (i[r].rowzones[u] !== t)
            for (o = 0; o < i[r].rowzones[u].length; o++)
              d += i[r].rowzones[u][o][0].offsetHeight;
          if (h !== u)
            for (o = 0; o < i[r].rowzones[h].length; o++)
              c += i[r].rowzones[h][o][0].offsetHeight;
        }
        if (i[r].srowzones && i[r].srowzones.length > 0)
          for (o = 0; o < i[r].srowzones.length; o++)
            p += i[r].srowzones[o][0].offsetHeight;
        d = d < p ? p : d;
        var g = Math.max(
          Math.max(i[r].minHeight, i[r].gridheight[i[r].level]),
          d
        );
        if (
          ((g = 0 !== i[r].maxHeight ? Math.min(i[r].maxHeight, g) : g),
          "fullwidth" != i[r].sliderLayout ||
            i[r].autoHeight ||
            punchgs.TweenMax.set(i[r].c, { maxHeight: g + "px" }),
          i[r].c.css({ marginTop: n, marginBottom: l }),
          (i[r].width = i[r].canvas.width()),
          (i[r].height = i[r].canvas.height()),
          "fullscreen" == i[r].sliderLayout || i[r].infullscreenmode)
        ) {
          ...
          i[r].fullScreenOffset != t &&
          !e.isNumeric(i[r].fullScreenOffset) &&
          i[r].fullScreenOffset.split("%").length > 1
            ? (f -=
                (e(window).height() * parseInt(i[r].fullScreenOffset, 0)) / 100)
            : i[r].fullScreenOffset != t &&
              i[r].fullScreenOffset.length > 0 &&
              e.isNumeric(parseInt(i[r].fullScreenOffset, 0)) &&
              (f -= parseInt(i[r].fullScreenOffset, 0)),
            (i[r].height = Math.max(d, Math.max(f - s, i[r].minHeight))),
            h !== u &&
              ((i[r].currentSlideHeight = Math.max(
                c,
                Math.max(f - s, i[r].minHeight)
              )),
              (i[r].slides[h].style.maxHeight =
                i[r].currentSlideHeight !== i[r].height
                  ? i[r].currentSlideHeight + "px"
                  : "none")),
            i[r].cpar.height(i[r].height),
            i[r].c.css({ height: "100%" });
        } else
          (i[r].height = Math.round(
            i[r].gridheight[i[r].level] *
              (i[r].keepBPHeight ? 1 : i[r].width / i[r].gridwidth[i[r].level])
          )),
            (i[r].height = Math.max(
              d,
              Math.max(
                i[r].autoHeight
                  ? i[r].height
                  : Math.min(i[r].height, i[r].gridheight[i[r].level]),
                i[r].minHeight
              )
            )),
            !1 !== a && i[r].c.height(i[r].height);
        var b =
            n + l + s + i[r].height + i[r].paddings.top + i[r].paddings.bottom,
          w = { height: b };
        if (
          (!1 !== a &&
            (i[r].c.closest("rs-fullwidth-wrap").find("rs-fw-forcer").css(w),
            i[r].c.closest("rs-module-wrap").css(w)),
          i[r].sbtimeline.set &&
            i[r].sbtimeline.fixed &&
            ((i[r].curheight = b),
            i[r].sbtimeline.extended === t && i.updateFixedScrollTimes(r),
            punchgs.TweenMax.set(i[r].forcer, {
              height: 2 * b + i[r].sbtimeline.extended,
            })),
          i[r].middleZones &&
            i[r].middleZones.length > 0 &&
            i[r].middleZones[u] !== t)
        )
          for (o = 0; o < i[r].middleZones[u].length; o++)
            i[r].middleZones[u][o].style.top =
              Math.round(b / 2 - i[r].middleZones[u][o].offsetHeight / 2) +
              "px";
        if (i[r].smiddleZones && i[r].smiddleZones.length > 0)
          for (o = 0; o < i[r].smiddleZones.length; o++)
            i[r].smiddleZones[o].style.top =
              Math.round(b / 2 - i[r].smiddleZones[o].offsetHeight / 2) + "px";
        y(r);
      },
      enterInViewPort: function (r) {
        i[r].waitForCountDown && (Q(r), (i[r].waitForCountDown = !1)),
          i[r].waitForFirstSlide &&
            (C(r),
            (i[r].waitForFirstSlide = !1),
            setTimeout(function () {
              i[r].c.removeClass("tp-waitforfirststart");
            }, 500)),
          ("playing" != i[r].sliderlaststatus && i[r].sliderlaststatus != t) ||
            i[r].c.trigger("starttimer"),
          i[r].lastplayedvideos != t &&
            i[r].lastplayedvideos.length > 0 &&
            e.each(i[r].lastplayedvideos, function (e, t) {
              i.playVideo(t, r);
            });
      },
      leaveViewPort: function (r) {
        (i[r].sliderlaststatus = i[r].sliderstatus),
          i[r].c.trigger("stoptimer"),
          i[r].playingvideos != t &&
            i[r].playingvideos.length > 0 &&
            ((i[r].lastplayedvideos = e.extend(!0, [], i[r].playingvideos)),
            i[r].playingvideos &&
              e.each(i[r].playingvideos, function (e, t) {
                (i[r].leaveViewPortBasedStop = !0),
      ...
      swaptoggleState: function (e) {
        if (e != t && e.length > 0)
          for (var r = 0; r < e.length; r++) {
            ...
            if (
              i.gA(a, "toggletimestamp") !== t &&
              new Date().getTime() - i.gA(a, "toggletimestamp") < 250
            )
              return;
            i.sA(a, "toggletimestamp", new Date().getTime()),
              null !== a &&
      ...
      lastToggleState: function (e) {
        ...
        if (e !== t)
          for (var r = 0; r < e.length; r++) {
            ...
            i =
              !0 === i ||
              (null !== a && a.className.indexOf("rs-tc-active") >= 0) ||
              i;
          }
        return i;
      },
      revCheckIDS: function (r, a) {
        if (i.gA(a, "idcheck") === t) {
          for (; -1 != e.inArray(a.id, i[r].anyid); )
            console.log("Warning !! Double Id in Slider " + r + ": " + a.id),
              (a.id = a.id + "_" + Math.round(9999 * Math.random()));
          i[r].anyid.push(a.id);
        }
        i.sA(a, "idcheck", !0);
      },
  ...
  var r = i.is_mobile(),
    a =
      ...
      function (e) {
        ...
        i[e].editorheight !== t &&
          (r = Math.max(r, i[e].editorheight[i[e].level] * i[e].bw)),
          punchgs.TweenMax.set(i[e].c, { height: r });
      }),
    o = function (t, i) {
      var r = [];
      return (
    ...
    l = function (t, r) {
      ...
      l &&
        ...
        e.each(l, function (e, r) {
          n < r &&
            (0 == o || o > parseInt(r)) &&
            ((a = parseInt(r)), (i[t].level = e), (o = parseInt(r))),
            n > r && o < r && ((o = parseInt(r)), (s = e));
        }),
        o < a && (i[t].level = s),
    ...
    c = function (a) {
      ...
      1 == s &&
        ...
        s > 1 && (window._rs_ie = !1),
        i[a].cpar !== t &&
          i[a].cpar.data("aimg") != t &&
          (("enabled" == i[a].cpar.data("aie8") && i.isIE(8)) ||
            ("enabled" == i[a].cpar.data("amobile") && r)) &&
          i[a].c.html(
            '<img class="tp-slider-alternative-image" src="' +
              i[a].cpar.data("aimg") +
              '">'
          ),
        (i[a].realslideamount = i[a].slideamount = 0);
        ...
        l.hasOwnProperty(d) &&
          ("on" == i.gA(l[d], "hsom") && r
            ...
            : (i.gA(l[d], "invisible") || 1 == i.gA(l[d], "invisible")
                ...
                : i[a].slideamount++,
              i[a].realslideamount++,
              i.sA(l[d], "originalindex", i[a].realslideamount),
              i.sA(l[d], "origindex", i[a].realslideamount - 1)));
      i[a].canvas.find(".removeslidenow").each(function () {
        ...
        i[a].canvas.css({ visibility: "visible" }),
        (i[a].slayers = i[a].c.find("rs-static-layers")),
        i[a].slayers.length > 0 && i.sA(i[a].slayers[0], "key", "staticlayers"),
        !0 === i[a].modal.useAsModal &&
          (i[a].cpar.wrap(
            '<rs-modal id="' + i[a].c[0].id + '_modal"></rs-modal>'
          ),
          (i[a].modal.c = i[a].cpar.closest("rs-modal")),
          i[a].modal.c.appendTo(e("body")),
          i[a].modal !== t &&
            i[a].modal.alias !== t &&
            i.revModal(a, { mode: "init" })),
    ...
    u = function (e, r, a) {
      return i.gA(e, "lazyload") !== t
        ? i.gA(e, "lazyload")
        : i[a].lazyloaddata !== t &&
          i[a].lazyloaddata.length > 0 &&
          i.gA(e, i[a].lazyloaddata) !== t
        ? i.gA(e, i[a].lazyloaddata)
        : i.gA(e, "lazy-src") !== t
        ? i.gA(e, "lazy-src")
    ...
    h = function (a) {
      if (i[a] !== t) {
        if (
          ...
          for (
            var o = i[a].canvas.find("rs-slide:first-child"),
            ...
            i[a].canvas
              .find(
                "rs-slide:eq(" +
                  Math.round(Math.random() * i[a].slideamount) +
                  ")"
              )
              .prependTo(i[a].canvas);
          i.sA(i[a].canvas.find("rs-slide:first-child")[0], "firstanim", s);
        }
        for (var d in ((i[a].slides =
          i[a].canvas[0].getElementsByTagName("rs-slide")),
        (i[a].thumbs = new Array(i[a].slides.length)),
        (i[a].slots = 4),
        (i[a].firststart = 1),
        (i[a].loadqueue = []),
        (i[a].syncload = 0),
          ...
          if (i[a].slides.hasOwnProperty(d) && "length" !== d) {
            ...
            if (
              ...
              if (_ != t && "no" != _ && "next" != _ && "prev" != _)
                for (var k in i[a].slides)
                  i[a].slides.hasOwnProperty(k) &&
                    parseInt(i.gA(i[a].slides[k], "origindex"), 0) + 1 ==
                      i.gA(c, "linktoslide") &&
                    (_ = i.gA(i[a].slides[k], "key"));
              e(c).append(
        ...
        if (
          (i[a].simplifyAll &&
            ...
            (i[a].c.find(".rs-layer").each(function () {
              var t = e(this);
          ...
          (window._rs_desktop =
            window._rs_desktop === t
              ...
              : window._rs_desktop),
          (i[a].autoHeight =
            "fullscreen" == i[a].sliderLayout || i[a].autoHeight),
          "fullwidth" != i[a].sliderLayout ||
            i[a].autoHeight ||
            i[a].c.css({ maxHeight: i[a].gridheight[i[a].level] + "px" }),
          "auto" == i[a].sliderLayout ||
            0 != i[a].c.closest("rs-fullwidth-wrap").length ||
            ("fullscreen" === i[a].sliderLayout &&
              1 == i[a].disableForceFullWidth))
        )
          i[a].topc = i[a].cpar;
        else {
          ...
          (T = T === t || "" === T ? "" : "margin-top:" + T + ";"),
            ...
            i[a].topc.append(i[a].forcer),
            i[a].topc.insertBefore(i[a].cpar),
            i[a].cpar.detach(),
            i[a].cpar.css({
              marginTop: "0px",
              marginBottom: "0px",
        ...
        if (
          (i[a].forceOverflow && i[a].topc[0].classList.add("rs-forceoverflow"),
          "carousel" === i[a].sliderType && i[a].c.css({ overflow: "visible" }),
          0 !== i[a].maxHeight &&
            punchgs.TweenMax.set([i[a].cpar, i[a].c, i[a].topc], {
              maxHeight: i[a].maxHeight + "px",
            }),
          i[a].fixedOnTop &&
            punchgs.TweenMax.set(i[a].topc, {
              position: "fixed",
              top: "0px",
              left: "0px",
              pointerEvents: "none",
          ...
          i[a].shadow !== t &&
            i[a].shadow > 0 &&
            i[a].cpar
              .addClass("tp-shadow" + i[a].shadow)
              .append(
                '<div class="tp-shadowcover" style="background-color:' +
                  i[a].cpar.css("backgroundColor") +
                  ";background-image:" +
                  i[a].cpar.css("backgroundImage") +
                  '"></div>'
              ),
          l(a),
          !i[a].c.hasClass("revslider-initialised"))
        ) {
          i[a].c[0].classList.add("revslider-initialised"),
            (i[a].c[0].id =
              i[a].c[0].id === t
                ? "revslider-" + Math.round(1e3 * Math.random() + 5)
                : i[a].c[0].id),
            i.revCheckIDS(a, i[a].c[0]),
            (i[a].origcd = parseInt(i[a].duration, 0)),
            (i[a].scrolleffect._L = []),
            (i[a].sbas = i[a].sbas === t ? {} : i[a].sbas),
            (i[a].layers = i[a].layers || {}),
            (i[a].sortedLayers = i[a].sortedLayers || {}),
            i[a].c.detach(),
            i[a].c
              .find(
              ...
              .each(function () {
                ...
                if (
                  ...
                  (n.startclasses =
                    n.startclasses === t || null === n.startclasses
                      ...
                      : n.startclasses),
                  (n.animationonscroll =
                    !!i[a].sbtimeline.set && i[a].sbtimeline.layers),
                  (n.animationonscroll =
                    !0 === n.animationonscroll ||
                    "true" == n.animationonscroll),
                  (n.filteronscroll =
                    !!i[a].scrolleffect.set && i[a].scrolleffect.layers),
                  (n.pxundermask =
                    n.startclasses.indexOf("rs-pxmask") >= 0 &&
                    "off" !== i[a].parallax.type &&
                    n.startclasses.indexOf("rs-pxl-") >= 0),
                  (n.noPevents = n.startclasses.indexOf("rs-noevents") >= 0),
                  n.sba)
                )
                  for (var l in (r = n.sba.split(";")))
                    r.hasOwnProperty(l) &&
                      ("t" == (o = r[l].split(":"))[0] &&
                ...
                if (
                  ...
                  s.wrap(
                    ...
                    (!0 !== n.filteronscroll && "true" != n.filteronscroll) ||
                      i[a].scrolleffect._L.push(s.parent()),
                    (s[0].id =
                      s[0].id === t
                ...
                i.gA(s[0], "actions") &&
                  i.checkActions &&
                  i.checkActions(s, a, i[a]),
                  !i.checkVideoApis ||
                    (window.rs_addedvim && window.rs_addedyt) ||
                    (i[a].youtubeapineeded && i[a].vimeoapineeded) ||
                    i.checkVideoApis(s, a);
              }),
            i.checkActions && i.checkActions(t, a),
            i[a].c.prependTo(i[a].cpar),
            i[a].c[0].addEventListener(
              "mouseenter",
              function () {
            ...
            "standard" !== i[a].sliderType && (i[a].lazyType = "all"),
            (i[a].rs_static_layer =
              i[a].c[0].getElementsByTagName("rs-static-layers")),
            i[a].rs_static_layer.length > 0 &&
              (I(i[a].rs_static_layer[0], a, 0, !0),
              z(i[a].rs_static_layer[0], a, function () {
                i[a] !== t &&
                  i[a].c.find("rs-static-layers img").each(function () {
                    this.src = A(
                      a,
          ...
          if (
            ...
            e.isNumeric(parseInt(S, 0)) &&
              ...
              S > i[a].slideamount && (S = i[a].slideamount),
              (i[a].startWithSlide = S - 1));
          }
          ...
          if (isNaN(M) || M < 6)
            ...
            j += ">";
            for (
              var H = [10, 0, 4, 2, 5, 9, 0, 4, 4, 2][M - 6], N = 0;
              N < H;
              N++
            )
              N > 0 && (j += " "),
                (j += '<span style="background:' + P + '"></span>');
            (j += "</div>"),
              (i[a].loader = e(
                '<rs-loader class="' +
                  i[a].spinner +
          ...
          i[a].c.append(i[a].loader),
            0 === i[a].c.find("rs-progress").length &&
              i[a].c.append(
                '<rs-progress style="visibility:hidden"></rs-progress>'
              ),
            i[a].c.find("rs-progress").css({ width: "0%" }),
            i[a].canvas.css({ display: "block" }),
            b(a),
            (i[a].slides = i[a].canvas.find("rs-slide").not(".rs-not-in-nav")),
            (i[a].inli = i[a].canvas.find("rs-slide.rs-not-in-nav")),
            ("off" !== i[a].parallax.type ||
              i[a].scrolleffect.set ||
              i[a].sbtimeline.set) &&
              i.checkForParallax &&
              i.checkForParallax(a),
            i.setSize(a, !1),
            "hero" !== i[a].sliderType &&
              i.createNavigation &&
              i[a].navigation.use &&
              i.createNavigation(a),
            i.resizeThumbsTabs &&
              i.resizeThumbsTabs &&
              i[a].navigation.use &&
              i.resizeThumbsTabs(a),
            g(a);
          var W = i[a].viewPort;
          (i[a].inviewport = !1),
            W != t && W.enable && i.scrollTicker && i.scrollTicker(a),
            i[a].slides.each(function (t) {
              var r = e(this);
              (i[a].rowzones[t] = []),
                (i[a].middleZones[t] = []),
                r.find("rs-zone").each(function () {
                  i[a].rowzones[t].push(e(this)),
                    this.className.indexOf("rev_row_zone_middle") >= 0 &&
                      i[a].middleZones[t].push(this);
                }),
                ((((W.enable && i[a].inviewport) || !W.enable) &&
                  "all" == i[a].lazyType) ||
                  ("smart" == i[a].lazyType &&
                    (0 == t ||
                      1 == t ||
                      t == i[a].slideamount ||
                      t == i[a].slideamount - 1))) &&
                  (I(r[0], a, t), z(r[0], a, function () {}));
            }),
            (i[a].srowzones = []),
            (i[a].smiddleZones = []),
            i[a].slayers.find("rs-zone").each(function () {
              i[a].srowzones.push(e(this)),
                this.className.indexOf("rev_row_zone_middle") >= 0 &&
                  i[a].smiddleZones.push(this);
            }),
            "carousel" === i[a].sliderType &&
              ...
              i.prepareCarousel(a, new punchgs.TimelineLite(), t, 0),
              (i[a].onlyPreparedSlide = !0)),
            setTimeout(function () {
              !W.enable ||
              (W.enable && i[a].inviewport) ||
              (W.enable && !i[a].inviewport && "wait" !== W.outof)
                ? C(a)
                : (i[a].c.addClass("tp-waitforfirststart"),
                  (i[a].waitForFirstSlide = !0),
                  W.presize &&
                    ((i[a].pr_next_slide = e(i[a].slides[0])),
                    I(i[a].pr_next_slide[0], a, 0, !0),
                    z(i[a].pr_next_slide.find(".tp-layers"), a, function () {
                      i.animateTheLayers &&
                        i.animateTheLayers({
                ...
                i[a].slideamount > 1 &&
                  (!W.enable || (W.enable && i[a].inviewport)
                    ? Q(a)
                    : (i[a].waitForCountDown = !0)),
                setTimeout(function () {
          ...
          e(window).on(V, function () {
            if (i[a] !== t) {
              ...
              if ("fullscreen" == i[a].sliderLayout) {
                ...
                ("mobile" == i[a].fallbacks.ignoreHeightChanges && r) ||
                "always" == i[a].fallbacks.ignoreHeightChanges
                  ? ((i[a].fallbacks.ignoreHeightChangesSize =
                      i[a].fallbacks.ignoreHeightChangesSize == t
                        ? 0
                        : i[a].fallbacks.ignoreHeightChangesSize),
                    (o =
                      s != i[a].lastwindowheight &&
                      Math.abs(s - i[a].lastwindowheight) >
                        i[a].fallbacks.ignoreHeightChangesSize))
                  : (o = s != i[a].lastwindowheight);
              }
              (i[a].c.outerWidth(!0) != i[a].width ||
                i[a].c.is(":hidden") ||
                o) &&
                ((i[a].lastwindowheight = e(window).height()), m(a));
            }
          }),
            f(a),
            g(a),
            i[a].fallbacks.disableFocusListener ||
              "true" == i[a].fallbacks.disableFocusListener ||
              !0 === i[a].fallbacks.disableFocusListener ||
              (i[a].c.addClass("rev_redraw_on_blurfocus"), D());
        }
      }
    },
    g = function (r) {
      ...
      if (
        ("auto" === i[r].sliderLayout ||
        ("fullscreen" === i[r].sliderLayout &&
          !0 === i[r].disableForceFullWidth)
          ? "fullscreen" == i[r].sliderLayout && 1 == i[r].disableForceFullWidth
            ? punchgs.TweenMax.set(i[r].cpar, { left: 0, width: "auto" })
          ...
          : punchgs.TweenMax.set(i[r].cpar, {
              left:
                0 -
                Math.ceil(
                  i[r].c.closest("rs-fullwidth-wrap").offset().left - a
                ) +
                "px",
        ...
        "auto" === i[r].sliderLayout &&
          i[r].modal !== t &&
          i[r].modal.useAsModal)
      ) {
        var o = Math.min(i[r].gridwidth[i[r].level], window.innerWidth);
        punchgs.TweenMax.set([i[r].modal.c, i[r].canvas], { width: o });
      }
      i[r].slayers &&
        "fullwidth" != i[r].sliderLayout &&
        "fullscreen" != i[r].sliderLayout &&
        punchgs.TweenMax.set(i[r].slayers, { left: a });
    },
    f = function (r, a) {
      e(window).width() < i[r].hideSliderAtLimit
        ? (i[r].c.trigger("stoptimer"),
          i.sA(
            i[r].cpar[0],
            "displaycache",
            "none" != i[r].cpar.css("display")
              ? i[r].cpar.css("display")
              : i.gA(i[r].cpar[0], "displaycache")
          ),
          i[r].cpar.css({ display: "none" }))
        : i[r].c.is(":hidden") &&
          a &&
          (i.gA(i[r].cpar[0], "displaycache") != t &&
          "none" != i.gA(i[r].cpar[0], "displaycache")
            ? i[r].cpar.css({ display: i.gA(i[r].cpar[0], "displaycache") })
            : i[r].cpar.css({ display: "block" }),
          i[r].c.trigger("restarttimer"),
          setTimeout(function () {
            m(r);
          }, 150)),
        i.hideUnHideNav && i[r].navigation.use && i.hideUnHideNav(r);
    },
    m = function (a) {
      if (i[a].c === t) return !1;
      i[a].c.trigger("revolution.slide.beforeredraw"),
        1 == i[a].infullscreenmode && (i[a].minHeight = e(window).height()),
        r && (i[a].lastMobileHeight = window.innerHeight),
        l(a),
    ...
    v = function (e, r) {
      r &&
        ...
        i.startPanZoom(
          r,
          e,
          r.data("pztl") !== t ? r.data("pztl").progress() : 0
        );
    },
    y = function (e) {
    ...
    b = function (r) {
      i[r].autoHeight &&
        punchgs.TweenMax.set([i[r].c, i[r].cpar], { maxHeight: "none" }),
        punchgs.TweenMax.set(i[r].canvas, {
          overflow: "hidden",
          width: "100%",
          height: "100%",
      ...
      for (var a = 0; a < i[r].slides.length; a++) {
        ...
        s.detach(),
          n.detach(),
          ((i[r].startWithSlide != t &&
            i.gA(i[r].slides[a], "originalindex") == i[r].startWithSlide) ||
            (i[r].startWithSlide === t && 0 == a)) &&
            (i[r].pr_next_key = o.index()),
        ...
        (c.src = s[0].src),
          ...
          "none" != i[r].dottedOverlay &&
            i[r].dottedOverlay != t &&
            l.append(
              '<rs-dotted class="' + i[r].dottedOverlay + '"></rs-dotted>'
            ),
          (h +=
            (p
              ? ""
          ...
          (h +=
            "standard" === i[r].sliderType || "undefined" === i[r].sliderType
              ? "opacity:0;"
              : ""),
        ...
        i.sA(o[0], "scroll-based", !!i[r].sbtimeline.set && m.s !== t && m.s),
          i[r].scrolleffect.set
            ? (i[r].scrolleffect.bgs.push({
                fade:
                  m.f !== t
                    ? m.f
                    : !!i[r].scrolleffect.slide && i[r].scrolleffect.fade,
                blur:
                  m.b !== t
                    ? m.b
                    : !!i[r].scrolleffect.slide && i[r].scrolleffect.blur,
                grayscale:
                  m.g !== t
                    ? m.g
                    : !!i[r].scrolleffect.slide && i[r].scrolleffect.grayscale,
    ...
    L = function (e, r, a) {
      if (i[r] !== t) {
        for (var o in (i[r].syncload--, i[r].loadqueue))
          if (
            i[r].loadqueue.hasOwnProperty(o) &&
            "loaded" !== i[r].loadqueue[o].progress
          ) {
            var s =
              i[r].loadqueue[o].src !== t
                ? i[r].loadqueue[o].src.replace(/\.\.\/\.\.\//gi, "")
                : i[r].loadqueue[o].src;
            (s === e.src ||
              k(s) === k(e.src) ||
              ...
              x(T(self.location.href, i[r].loadqueue[o].src)) ===
                x(decodeURIComponent(e.src)) ||
              x(document.location.origin + "/" + s) ===
                x(decodeURIComponent(e.src)) ||
              x(
              ...
              x(i[r].loadqueue[o].src) === x(decodeURIComponent(e.src)) ||
              ("file://" === window.location.origin &&
                x(e.src).match(new RegExp(s)))) &&
              ((i[r].loadqueue[o].progress = a),
              (i[r].loadqueue[o].width = e.width),
              (i[r].loadqueue[o].height = e.height));
          }
        R(r);
      }
    },
    R = function (t) {
      4 != i[t].syncload &&
        i[t].loadqueue &&
        e.each(i[t].loadqueue, function (r, a) {
          if ("prepared" == a.progress && i[t].syncload <= 4) {
            if ((i[t].syncload++, "img" == a.type)) {
              ...
              e.get(a.src, function (e) {
                (a.innerHTML = new XMLSerializer().serializeToString(
                  e.documentElement
                )),
                  (a.progress = "loaded"),
                  i[t].syncload--,
      ...
      if (r !== t && 0 !== r.length) {
        ...
        for (var l in n)
          if (n.hasOwnProperty(l)) {
            ...
            c !== t &&
              0 ==
                i[a].loadqueue.filter(function (e) {
                  return e.src === c;
                }).length &&
              i[a].loadqueue.push({
                src: c,
          ...
          if (
              ...
              if (((l[d].src = g.src), "img" == g.type)) {
                if (c.slidebgimage) {
                  ...
                  c.bgcolor === t
                    ...
                    i.sA(a, "owidth", g.width),
                    i.sA(a, "oheight", g.height);
            ...
            g &&
              ...
              1 != i[o].youtubeapineeded ||
                ...
                (n = M("youtube", o)),
              1 != i[o].vimeoapineeded || window.Vimeo || (n = M("vimeo", o));
          }
        !r &&
          i[o].audioqueue &&
          ...
          n
            ? punchgs.TweenMax.delayedCall(0.18, z, [a, o, s])
    ...
    M = function (t, r) {
      if (e.now() - i[r][t + "starttime"] > 5e3 && 1 != i[r][t + "warning"]) {
        ...
        "https:" === location.protocol &&
          (a += " Please Check and Renew SSL Certificate !"),
          console.error(a),
          i[r].c.append(
    ...
    O = function (r) {
      i[r] !== t &&
        ...
        punchgs.TweenMax.to([i[r].pr_active_bg, i[r].pr_next_bg], 0.5, {
          opacity: 0,
        }),
        ...
        i.removeTheLayers &&
          i[r].pr_active_key !== t &&
          i.removeTheLayers(i[r].pr_active_slide, r, !0),
        (i[r].firststart = 1),
        setTimeout(function () {
    ...
    C = function (r, a) {
      if (i[r] !== t)
        if (
          (clearTimeout(i[r].waitWithSwapSlide), i[r].pr_processing_key === t)
        ) {
          if (
            (i[r].startWithSlideKey !== t &&
              ((i[r].pr_next_key = i.getComingSlide(
                r,
                i[r].startWithSlideKey
              ).nindex),
              delete i[r].startWithSlideKey),
            (i[r].pr_active_slide = e(i[r].slides[i[r].pr_active_key])),
            (i[r].pr_next_slide = e(i[r].slides[i[r].pr_next_key])),
            i[r].pr_next_key == i[r].pr_active_key &&
              !0 !== i[r].onlyPreparedSlide)
          )
            return delete i[r].pr_next_key;
          !0 === i[r].onlyPreparedSlide && (i[r].onlyPreparedSlide = !1),
            (i[r].pr_processing_key = i[r].pr_next_key),
            delete i[r].pr_next_key,
            i[r].pr_next_slide !== t &&
              i[r].pr_next_slide[0] !== t &&
              i.gA(i[r].pr_next_slide[0], "hal") !== t &&
              i.sA(
                i[r].pr_next_slide[0],
                "sofacounter",
                i.gA(i[r].pr_next_slide[0], "sofacounter") === t
                  ? 1
                  : parseInt(i.gA(i[r].pr_next_slide[0], "sofacounter"), 0) + 1
              ),
            i[r].stopLoop &&
              i[r].pr_processing_key == i[r].lastslidetoshow - 1 &&
              (i[r].c.find("rs-progress").css({ visibility: "hidden" }),
              i[r].c.trigger("revolution.slide.onstop"),
              (i[r].noloopanymore = 1)),
            i[r].pr_next_slide.index() === i[r].slideamount - 1 &&
              i[r].looptogo > 0 &&
              "disabled" !== i[r].looptogo &&
              (i[r].looptogo--, i[r].looptogo <= 0 && (i[r].stopLoop = !0)),
            (i[r].tonpause = !0),
            i[r].c.trigger("stoptimer"),
            "off" === i[r].spinner &&
              (i[r].loader !== t
                ...
                : (i[r].loadertimer = setTimeout(function () {
                    i[r].loader !== t && i[r].loader.css({ display: "block" });
                  }, 18))),
            I(i[r].pr_next_slide[0], r, 1),
            i.preLoadAudio && i.preLoadAudio(i[r].pr_next_slide, r, 1),
            z(i[r].pr_next_slide[0], r, function () {
              i[r] !== t &&
                (i[r].pr_next_slide.find("rs-bgvideo").each(function () {
                  var t = e(this);
                  t.hasClass("HasListener") ||
                    (t.data("bgvideo", 1),
                    i.manageVideoLayer && i.manageVideoLayer(t, r)),
          ...
          i[r].waitWithSwapSlide = setTimeout(function () {
            C(r, a);
          }, 18);
    },
    P = function (r, a, o) {
      if (i[a] !== t) {
        if (
          ...
          (i[a].tonpause = !1),
          clearTimeout(i[a].loadertimer),
          i[a].loader !== t && i[a].loader.css({ display: "none" }),
          i.setSize(a),
          i.manageNavigation &&
            i[a].navigation.use &&
            i.manageNavigation(a, !1),
          i[a].c.trigger("revolution.slide.onbeforeswap", {
            slider: a,
            ...
            prevslide:
              i[a].pr_lastshown_key !== t
                ? i[a].slides[i[a].pr_lastshown_key]
                : "",
          }),
          (i[a].transition = 1),
          (i[a].stopByVideo = !1),
          i[a].pr_next_slide[0] !== t &&
          i.gA(i[a].pr_next_slide[0], "duration") != t &&
          "" != i.gA(i[a].pr_next_slide[0], "duration")
            ? (i[a].duration = parseInt(
                i.gA(i[a].pr_next_slide[0], "duration"),
                0
              ))
            : (i[a].duration = i[a].origcd),
          i[a].pr_next_slide[0] === t ||
          ("true" != i.gA(i[a].pr_next_slide[0], "ssop") &&
            !0 !== i.gA(i[a].pr_next_slide[0], "ssop"))
            ? (i[a].ssop = !1)
            : (i[a].ssop = !0),
          i[a].sbtimeline.set &&
            i[a].sbtimeline.fixed &&
            i.updateFixedScrollTimes(a),
          i[a].c.trigger("nulltimer"),
          (i[a].sdir = i[a].pr_processing_key < i[a].pr_active_key ? 1 : 0),
          "arrow" == i[a].sc_indicator &&
            (0 == i[a].pr_active_key &&
              i[a].pr_processing_key == i[a].slideamount - 1 &&
              (i[a].sdir = 1),
            i[a].pr_active_key == i[a].slideamount - 1 &&
              0 == i[a].pr_processing_key &&
              (i[a].sdir = 0)),
          (i[a].lsdir = i[a].sdir),
          i[a].pr_active_key != i[a].pr_processing_key &&
            1 != i[a].firststart &&
            "carousel" !== i[a].sliderType &&
            i.removeTheLayers &&
            i.removeTheLayers(i[a].pr_active_slide, a),
          i[a].pr_next_slide.hasClass("rs-pause-timer-once") ||
          i[a].pr_next_slide.hasClass("rs-pause-timer-always")
            ? (i[a].stopByVideo = !0)
            : i[a].c.trigger("restarttimer"),
          i[a].pr_next_slide.removeClass("rs-pause-timer-once"),
          i[a].pr_next_slide[0] !== t &&
            i.sA(i[a].c[0], "slideactive", i.gA(i[a].pr_next_slide[0], "key")),
          "carousel" == i[a].sliderType)
        )
          (i[a].mtl = new punchgs.TimelineLite()),
            i.prepareCarousel(a, i[a].mtl),
            j(a),
            (i[a].transition = 0);
        else {
          (i[a].mtl = new punchgs.TimelineLite({
            ...
            i[a].mtl.add(
              punchgs.TweenMax.set(i[a].pr_next_bg.find("rs-sbg"), {
                opacity: 0,
              })
            ),
            i[a].mtl.pause(),
            ...
            1 == i[a].firststart &&
              (punchgs.TweenMax.set(i[a].pr_active_slide, { autoAlpha: 0 }),
              (i[a].firststart = 0)),
            ...
            "prepared" == i.gA(i[a].pr_next_slide[0], "differentissplayed") &&
              (i.sA(i[a].pr_next_slide[0], "differentissplayed", "done"),
              i.sA(
                i[a].pr_next_slide[0],
                "anim",
                i.gA(i[a].pr_next_slide[0], "savedanim")
              )),
            i.gA(i[a].pr_next_slide[0], "firstanim") != t &&
              "done" != i.gA(i[a].pr_next_slide[0], "differentissplayed") &&
              (i.sA(
                i[a].pr_next_slide[0],
                "savedanim",
              ...
              i.sA(
                i[a].pr_next_slide[0],
                "anim",
                i.gA(i[a].pr_next_slide[0], "firstanim")
              ),
              i.sA(i[a].pr_next_slide[0], "differentissplayed", "prepared"));
          var s = (function (e) {
            ...
            r.transition === t && (r = { transition: ["fade"] });
            return r;
          })(i.gA(i[a].pr_next_slide[0], "anim"));
          i.sA(
            i[a].pr_next_slide[0],
            "ntrid",
            "on" == i.gA(i[a].pr_next_slide[0], "rndtrans")
              ? Math.round(80 * Math.random())
              : parseInt(i.gA(i[a].pr_next_slide[0], "ntrid"), 0) + 1 || 0
          ),
            i.sA(
              i[a].pr_next_slide[0],
              "ntrid",
              s.transition === t ||
                i.gA(i[a].pr_next_slide[0], "ntrid") == s.transition.length
                ? 0
                : i.gA(i[a].pr_next_slide[0], "ntrid")
            ),
            i.animateSlide({
              animation: s,
            ...
            i[a].pr_next_bg.data("panzoom") !== t &&
              (i.startPanZoom(i[a].pr_next_bg, a),
              i[a].mtl.add(
                punchgs.TweenMax.set(i[a].pr_next_bg, { autoAlpha: 0 })
              )),
            i[a].mtl.pause();
        }
        i.scrollHandling &&
          i[a].mtl !== t &&
          (i.scrollHandling(a, !0, 0),
          i[a].mtl.eventCallback("onUpdate", function () {
            i.scrollHandling(a, !0, 0, !0);
          })),
          "off" != i[a].parallax.type &&
            i[a].parallax.firstgo == t &&
            i.scrollHandling &&
            ((i[a].parallax.firstgo = !0),
            (i[a].lastscrolltop = -999),
            i.scrollHandling(a, !0, 0),
            setTimeout(function () {
              i[a] !== t &&
                ((i[a].lastscrolltop = -999), i.scrollHandling(a, !0, 0));
            }, 70),
            setTimeout(function () {
              i[a] !== t &&
                ((i[a].lastscrolltop = -999), i.scrollHandling(a, !0, 0));
          ...
          i.animateTheLayers
            ? "carousel" === i[a].sliderType
              ? i[a].carousel.showLayersAllTime
                ? (e.each(i[a].slides, function (e) {
                    i[a].carousel.allLayersStarted
                      ? i.animateTheLayers({ slide: e, id: a, mode: "rebuild" })
                      : i.animateTheLayers({ slide: e, id: a, mode: "start" });
                  }),
                  (i[a].carousel.allLayersStarted = !0))
                : (0 !== i[a].firststart
                    ? i.animateTheLayers({ slide: 0, id: a, mode: "start" })
                    : !0 !== o &&
                      i.animateTheLayers({
                        slide:
                          i[a].pr_next_key !== t
          ...
          punchgs.TweenMax.to(i[a].pr_next_slide, 0.001, { autoAlpha: 1 });
      }
    };
  var j = function (a) {
      if (
        i[a] !== t &&
        (i[a].firstSlideAvailable === t &&
          ((i[a].firstSlideAvailable = !0),
          i.showFirstTime !== t && i.showFirstTime(a)),
        "carousel" === i[a].sliderType ||
          (punchgs.TweenMax.to(i[a].pr_next_bg.find("rs-sbg"), 0.001, {
            zIndex: 20,
            autoAlpha: 1,
            onComplete: function () {
          ...
          i[a].pr_next_slide.index() != i[a].pr_active_slide.index() &&
            punchgs.TweenMax.to(i[a].pr_active_slide, 0.2, {
              zIndex: 18,
              autoAlpha: 0,
              onComplete: function () {
        ...
        ("scroll" != i[a].parallax.type &&
          "scroll+mouse" != i[a].parallax.type &&
          "mouse+scroll" != i[a].parallax.type) ||
          ((i[a].lastscrolltop = -999), i.scrollHandling(a)),
        (i[a].mtldiff = i[a].mtl.time()),
        delete i[a].mtl,
        i[a].pr_active_key !== t)
      ) {
        i.gA(i[a].slides[i[a].pr_active_key], "sloop") !== t &&
          (function (e) {
            if (i[e] !== t) {
              ...
              if (a === t) {
                ...
                (a.r = "unlimited" === a.r ? -1 : parseInt(a.r, 0)),
                  (i[e].sloops[r] = a),
                  (a.key = r);
              }
              (a.ct = { time: a.s }),
                (a.tl = new punchgs.TimelineMax({})),
                (a.timer = punchgs.TweenMax.fromTo(
                  a.ct,
                  a.e - a.s,
                  { time: a.s },
                  {
                    ...
                    onRepeat: function () {
                      for (var r in i[e].layers[a.key])
                        i[e].layers[a.key].hasOwnProperty(r) &&
                          i[e]._L[r].timeline.play(a.s);
                ...
                a.tl.add(a.timer, a.s),
                a.tl.time(i[e].mtldiff);
            }
          })(a),
          i[a].c.find(".active-rs-slide").removeClass("active-rs-slide"),
          e(i[a].slides[i[a].pr_active_key]).addClass("active-rs-slide"),
          i.sA(
            i[a].c[0],
            "slideactive",
            i.gA(i[a].slides[i[a].pr_active_key], "key")
          ),
          i[a].pr_active_bg.data("pztl") != t &&
            (i[a].pr_active_bg.data("pztl").reverse(),
            i[a].pr_active_bg.data("pztl").timeScale(25)),
          i[a].pr_next_bg.data("panzoom") !== t &&
            (i[a].pr_next_bg.data("pztl") != t
              ? (i[a].pr_next_bg.data("pztl").timeScale(1),
                i[a].pr_next_bg.data("pztl").play())
              : i.startPanZoom(i[a].pr_next_bg, a)),
          i[a].pr_next_slide.find("rs-bgvideo").each(function (t) {
            if (r && !i[a].fallbacks.allowHTML5AutoPlayOnAndroid) return !1;
            var o = e(this);
            i.resetVideo(o, a, !1, !0),
              punchgs.TweenMax.fromTo(
                o,
                0.25,
                { autoAlpha: 0 },
          ...
          i[a].pr_active_bg.find("rs-bgvideo").each(function (t) {
            if (r && !i[a].fallbacks.allowHTML5AutoPlayOnAndroid) return !1;
            var o = e(this);
            i.stopVideo && (i.resetVideo(o, a), i.stopVideo(o, a)),
        ...
        var o = {
          ...
          prevSlideIndex:
            i[a].pr_lastshown_key !== t &&
            parseInt(i[a].pr_lastshown_key, 0) + 1,
          prevSlideLIIndex:
            i[a].pr_lastshown_key !== t && parseInt(i[a].pr_lastshown_key, 0),
          prevSlide:
            i[a].pr_lastshown_key !== t && i[a].slides[i[a].pr_lastshown_key],
        };
        if (
          (i[a].c.trigger("revolution.slide.onchange", o),
          i[a].c.trigger("revolution.slide.onafterswap", o),
          (i[a].pr_lastshown_key = i[a].pr_active_key),
          i[a].startWithSlide !== t &&
            "done" !== i[a].startWithSlide &&
            "carousel" === i[a].sliderType)
        ) {
          for (
            var s = i[a].startWithSlide, n = 0;
            n <= i[a].slides.length - 1;
            n++
          )
            i[a].slides[n] !== t &&
              i[a].slides[n][0] !== t &&
              i.gA(i[a].slides[n][0], "originalindex") ===
                i[a].startWithSlide &&
              (s = n);
          0 !== s && i.callingNewSlide(a, s), (i[a].startWithSlide = "done");
        }
        (i[a].duringslidechange = !1),
          i[a].pr_active_slide.length > 0 &&
            0 != i.gA(i[a].pr_active_slide[0], "hal") &&
            i.gA(i[a].pr_active_slide[0], "hal") <=
              i.gA(i[a].pr_active_slide[0], "sofacounter") &&
            i[a].c.revremoveslide(i[a].pr_active_slide.index());
        var l = i[a].pr_processing_key || i[a].pr_active_key || 0;
        i[a].rowzones != t &&
          (l = l > i[a].rowzones.length ? i[a].rowzones.length : l),
          i[a].rowzones != t &&
            i[a].rowzones.length > 0 &&
            i[a].rowzones[l] != t &&
            l >= 0 &&
            l <= i[a].rowzones.length &&
            i[a].rowzones[l].length > 0 &&
            i.setSize(a),
          delete i[a].sc_indicator,
          delete i[a].sc_indicator_dir,
          i[a].firstLetItFree === t &&
            (i.scrollHandling && i.scrollHandling(a, !0),
            (i[a].firstLetItFree = !0));
      }
    },
    Q = function (a) {
      (i[a].loop = 0),
        i[a].stopAtSlide != t && i[a].stopAtSlide > -1
          ? (i[a].lastslidetoshow = i[a].stopAtSlide)
          : (i[a].lastslidetoshow = 999),
        (i[a].stopLoop = !1),
        0 == i[a].looptogo && (i[a].stopLoop = !0);
      var o = i[a].c.find("rs-progress");
      i[a].c.on("stoptimer", function () {
        var t = e(this).find("rs-progress");
        t[0].tween.pause(),
          i[a].disableProgressBar && t.css({ visibility: "hidden" }),
          (i[a].sliderstatus = "paused"),
          i.unToggleState(i[a].slidertoggledby);
      }),
        i[a].c.on("starttimer", function () {
          i[a].forcepaused ||
            (1 != i[a].conthover &&
              1 != i[a].stopByVideo &&
              i[a].width > i[a].hideSliderAtLimit &&
              1 != i[a].tonpause &&
              1 != i[a].overnav &&
              1 != i[a].ssop &&
              (1 === i[a].noloopanymore ||
                (i[a].viewPort.enable && !i[a].inviewport) ||
                (o.css({ visibility: "visible" }),
                o[0].tween.resume(),
                (i[a].sliderstatus = "playing"))),
            i[a].disableProgressBar && o.css({ visibility: "hidden" }),
        ...
        i[a].c.on("restarttimer", function () {
          if (!i[a].forcepaused) {
            var t = e(this).find("rs-progress");
            if (
              i[a].mouseoncontainer &&
              "on" == i[a].navigation.onHoverStop &&
              !r
            )
              return !1;
            1 === i[a].noloopanymore ||
      ...
      (o[0].tween = punchgs.TweenMax.fromTo(
        ...
        i[a].slideamount > 1 &&
        (0 != i[a].stopAfterLoops || 1 != i[a].stopAtSlide)
          ? i[a].c.trigger("starttimer")
          : ((i[a].noloopanymore = 1), i[a].c.trigger("nulltimer")),
        i[a].c.on("tp-mouseenter", function () {
          (i[a].mouseoncontainer = !0),
            1 != i[a].navigation.onHoverStop ||
              r ||
              (i[a].c.trigger("stoptimer"),
              i[a].c.trigger("revolution.slide.onpause"));
        }),
        i[a].c.on("tp-mouseleft", function () {
          (i[a].mouseoncontainer = !1),
            1 != i[a].c.data("conthover") &&
              1 == i[a].navigation.onHoverStop &&
              ((1 == i[a].viewPort.enable && i[a].inviewport) ||
                0 == i[a].viewPort.enable) &&
              (i[a].c.trigger("revolution.slide.onresume"),
              i[a].c.trigger("starttimer"));
        });
    },
    H = function () {
    ...
    V = function (i) {
      return (function (i) {
        ...
        i.navigation.maintypes))
          i.navigation.maintypes.hasOwnProperty(r) &&
            i.navigation[i.navigation.maintypes[r]] !== t &&
            ((i.navigation[i.navigation.maintypes[r]].animDelay =
              parseInt(i.navigation[i.navigation.maintypes[r]].animDelay, 0) /
              1e3),
            (i.navigation[i.navigation.maintypes[r]].animSpeed =
              parseInt(i.navigation[i.navigation.maintypes[r]].animSpeed, 0) /
              1e3));
        if (
          ...
          for (i.lazyloaddata = a[0], r = 1; r < a.length; r++)
            i.lazyloaddata += W(a[r]);
        }
          ...
          switch (r[0]) {
            ...
            case "o":
              t.on =
                "click" === r[1] || "c" === r[1]
                  ? "click"
                  : "ml" === r[1] || "mouseleave" === r[1]
                  ? "mouseleave"
                  : "mouseenter" === r[1] || "me" === r[1]
                  ? "mouseenter"
                  : r[1];
              break;
            case "d":
              (t.delay = parseInt(r[1], 0) / 1e3),
    ...
    jQuery.extend(!0, t, {
      prepareCarousel: function (e, o, n, l) {
        void 0 !== e &&
          ((n = t[e].carousel.lastdirection =
            r(n, t[e].carousel.lastdirection)),
          i(e),
      ...
      organiseCarousel: function (e, i, r, a) {
        ...
        var c = 999,
          ...
          u = t[e].ulw;
        t[e].slides &&
          jQuery.each(t[e].slides, function (a, l) {
            var d = s[a],
              h = {};
            o.infinity &&
              ((d =
                (d =
                  ...
                  "left" === i
                    ? s[0] - (n - a) * o.slide_width
                    : d) <
                0 - o.inneroffset - 3 * o.slide_width
                  ? "left" == i
                    ? d + o.maxwidth
                    : "right" === i
                    ? s[n - 1] + (a + 1) * o.slide_width
                    : d
                  : d),
              (u = u > d ? d : u) > 0 &&
                d > o.wrapwidth &&
                (d =
                  o.slide_offset - (t[e].slides.length - a) * o.slide_width)),
    ...
    var i = function (e) {
      ...
      a = function (e, i, a, o) {
        ...
        (n.from = 0),
          ...
          0 !== (o = a ? o * (Math.abs(n.to) / s.wrapwidth) : o) &&
            o < 0.1 &&
            Math.abs(n.to) > 25 &&
            (o = 0.3),
  ...
  (function (e) {
    ...
    jQuery.extend(!0, i, {
      checkLayerDimensions: function (e) {
        ...
        for (var r in i[e.id].layers[e.skey])
          if (i[e.id].layers[e.skey].hasOwnProperty(r) && !t) {
            ...
            i[e.id]._L[a.id].eow !== a.offsetWidth &&
              "true" !== i.gA(a, "vary-layer-dims") &&
              (t = !0);
          }
        return t;
      },
          ...
          if (i[o].layers[s].hasOwnProperty(n)) {
            ...
            if (void 0 === i.gA(c, "initialised")) {
              if (
                ...
                g.clip))
                  g.clip.hasOwnProperty(t) &&
                    ("u" == (r = g.clip[t].split(":"))[0] &&
                      (g.clipPath.use = "true" == r[1]),
                    "o" == r[0] && (g.clipPath.origin = r[1]),
                    "t" == r[0] && (g.clipPath.type = r[1]));
              if (
                ((g.frames = w(g, o)),
                (g.c = h),
              ...
              if (
                ...
                for (t in ((a = g.corners.split(";")), (g.corners = {}), a))
                  a.hasOwnProperty(t) &&
                    a[t].length > 0 &&
                    ((g.corners[a[t]] = jQuery(
                      "<" + a[t] + "></" + a[t] + ">"
                    )),
                    g.c.append(g.corners[a[t]]));
            ...
            if (
              ...
              if (
                ...
                (S =
                  "auto" === S
                    ? S
                    : !jQuery.isNumeric(S) && S.indexOf("%") > 0
                ...
                if (
                  ...
                  -1 != h[0].className.indexOf("rs-fsv") || z
                    ? ((l = 0),
                      (d = 0),
                    ...
                    ((0 == g.html5vid && !z) ||
                      (1 != g.forcecover && !h.hasClass("rs-fsv") && !z)) &&
                      (g.media.width(S), g.media.height(M)),
                    g._ingroup &&
                      null != S &&
                      !jQuery.isNumeric(S) &&
                      S.indexOf("%") > 0 &&
                      punchgs.TweenMax.set([g.lp, g.p, g.m], { minWidth: S });
              }
          ...
          null != r &&
            ...
            "1sttime" == r.aplay
              ? (("carousel" === i[t].sliderType &&
                ...
                (r.aplay1 || "1sttime" == r.aplay) &&
                  ((r.aplay1 = !1), (r.aplay = !1)))
              : ("no1sttime" == r.aplay && (r.aplay = !0),
      ...
      handleStaticLayers: function (e, t) {
        ...
        (r = Math.max(0, r)),
          (a = Math.min(
            i[t].realslideamount,
            a < 0 ? i[t].realslideamount : a
          )),
          (a =
            (1 !== r && 0 !== r) || a !== i[t].realslideamount
              ? a
              : i[t].realslideamount + 1),
          e.data("startslide", r),
          e.data("endslide", a),
          i.sA(e[0], "startslide", r),
          i.sA(e[0], "endslide", a);
      },
        ...
        if (
          ...
          i[t].dimensionReCheck ||
            (setTimeout(function () {
              void 0 !== r &&
                i[t].layers[r] &&
                i.checkLayerDimensions({ id: t, skey: r }) &&
                i.initLayer({ id: t, skey: r, mode: "updateposition" }),
                i[t].layers.static &&
          ...
          ((void 0 !== i[t].rowzones &&
            ...
            a >= 0 &&
            i[t].rowzones[Math.min(a, i[t].rowzones.length)].length > 0) ||
              ...
              if ("frame_0" !== I && "frame_hover" !== I && "loop" !== I) {
                ...
                if (
                  ...
                  var z = u.frames[I],
                    ...
                    C = u.c,
                    P =
                      void 0 !== z.sfx && g(z.sfx.effect, u.m, z.timeline.ease),
                  ...
                  "block" === P.type &&
                    ...
                    void 0 !== z.bgcolor
                      ? z.bgcolor.indexOf("gradient") >= 0
                        ? (H.background = z.bgcolor)
                        : (H.backgroundColor = z.bgcolor)
                      : !0 === u.bgcolinuse &&
                    ...
                    void 0 !== S &&
                      (void 0 !== S.bgcolor
                        ? S.bgcolor.indexOf("gradient") >= 0
                          ? (N.background = S.bgcolor)
                          : (N.backgroundColor = S.bgcolor)
                        : !0 === u.bgcolinuse &&
                          (u.bgcol.indexOf("gradient") >= 0
                  ...
                  if (void 0 !== u.splitText && !1 !== u.splitText)
                    for (var Y in t)
                      if (void 0 === z[t[Y]] || u.quickRendering)
                        u.fff
                          ? M.add(
                              O.fromTo(
                                u.splitText[t[Y]],
                  ...
                  (j += u.frames[I].split ? Q * V : 0),
                    u.pxundermask ||
                    (void 0 !== D &&
                      ((void 0 !== S && "hidden" === S.mask.overflow) ||
                        "hidden" === z.mask.overflow))
                      ? (M.add(
                  ...
                  var U =
                    ("trigger" !== e.mode &&
                      ((!0 !== b && "skiprest" !== b) ||
                        "rebuild" !== e.mode)) ||
                    e.frame === I ||
                    void 0 === z.timeline.start ||
                    !jQuery.isNumeric(z.timeline.start)
                      ? "+=0" === z.timeline.start ||
                        void 0 === z.timeline.start
                        ? "+=0.005"
                        : parseInt(z.timeline.start, 0) / 1e3
                      : "+=" + parseInt(z.timeline.startRelative, 0) / 1e3;
          ...
          if (void 0 !== u.frames.loop) {
            ...
            if (
              ...
              u.timeline.fromTo(
                ...
                $.to(u.lp, u.frames.loop.timeline.yoyo_move ? re / 2 : re, {
                  bezier: le,
            ...
            ie.to(u.lp, u.frames.loop.timeline.yoyo_filter ? re / 2 : re, ce),
              u.timeline.add(K, oe);
          }
          if (
            void 0 !== u.frames.frame_hover &&
                  ...
                  function () {
                    (u.elementHovered = !1),
                      u.readyForHover &&
                        ...
                        u.hovertimeline.eventCallback("onReverseComplete", a, [
                          { id: c, L: d },
                        ]));
                  }
                ));
    ...
    var r = function (e) {
      ...
      o = function (e) {
        ...
        r &&
          r.time() > 0 &&
          (r.pause(), r.time(0), r.kill(), delete t.hovertimeline),
        ...
        (i[e.id]._L[e.L[0].id].ignoremousemove = !1),
          ...
          (a.eventtype =
            "frame_0" === e.frame || "frame_1" === e.frame
              ...
              ? "leavestage"
              : "framestarted"),
          (a.layertype = i[e.id]._L[e.L[0].id].type),
          (a.frame_index = e.frame),
          (a.layersettings = i[e.id]._L[e.L[0].id]),
          i[e.id].c.trigger("revolution.layeraction", [a]),
      ...
      n = function (e) {
        ...
        if (
          ...
          a++,
            (a =
              i[e.id]._L[e.L[0].id].ford.length > a
                ? i[e.id]._L[e.L[0].id].ford[a]
                : r),
      ...
      g = function (e, t, i) {
        if (void 0 !== e && e.indexOf("block") >= 0) {
          ...
          switch (
            ...
            (r.bmask_in = t.find(".tp-blockmask_in")),
            (r.bmask_out = t.find(".tp-blockmask_out")),
            (r.type = "block"),
            e)
          ) {
            case "blocktoleft":
            case "blockfromright":
              (r.ft[0].transformOrigin = "100% 50%"),
                (r.t.transformOrigin = "0% 50%");
              break;
            case "blockfromtop":
            case "blocktobottom":
              (r.ft = [
      ...
      m = function (e) {
        var t = i[e.id]._L[e.layer[0].id],
          ...
          a = { originX: "50%", originY: "50%", originZ: "0" },
          o = i[e.id].conw,
          s = i[e.id].conh;
        for (var n in r)
          if (r.hasOwnProperty(n))
            if (
              ((r[n] = "object" == typeof r[n] ? r[n][i[e.id].level] : r[n]),
              "inherit" === r[n] ||
                "delay" === n ||
                "direction" === n ||
                "use" === n)
              ...
              (a[n] = r[n]), delete r[n];
            else if (jQuery.isNumeric(r[n], 0))
              r[n] = f(r[n], e.frame.reverse, e.target, n, e.id, e.id);
              ...
              (r[n] = r[n].replace("[", "").replace("]", "")),
                (r[n] = r[n].replace("cyc(", "").replace(")", ""));
              var p = parseInt(r[n], 0);
              if (r[n].indexOf("%") >= 0 && jQuery.isNumeric(p))
                "x" == n
                  ? (r[n] = f(
                      (t.eow * p) / 100,
                      e.frame.reverse,
        ...
        if (
          ((r.transformOrigin = a.originX + " " + a.originY + " " + a.originZ),
      ...
      y = function (e, t) {
        ...
        switch (t) {
          ...
          case "middletoedge":
            var n = Math.ceil(o / 2);
            for (a = n - 1, r = n + 1, s.push(n), i = 0; i < n; i++)
              a >= 0 && s.push(a), r <= o && s.push(r), a--, r++;
            break;
          case "e":
          case "edgetomiddle":
            for (a = o, r = 0, i = 0; i <= Math.floor(o / 2); i++)
              s.push(a), r < a && s.push(r), a--, r++;
            break;
          default:
            for (i = 0; i <= o; i++) s.push(i);
        }
      ...
      b = function (e, t, r, a, o) {
        ...
        "loop" === o
          ? ((c.autoRotate = !1),
            ...
            (l.rotationY = "0deg"),
            (l.rotationZ = "0deg"))
          : ((c.speed = 300), r ? (c.ease = "default") : (l.ease = "default")),
        "sfx" === o && (l.fxc = "#ffffff"),
        (e = e.split(";"))))
      ...
      w = function (e, t) {
        ...
        e.ford))
          if (e.ford.hasOwnProperty(a)) {
            ...
            if (e[s]) {
              if (
                ((r[s] = b(e[s], t, !0)),
                void 0 !== r[s].bgcolor && (e.bgcolinuse = !0),
                i[t].BUG_ie_clipPath &&
                  void 0 !== e.clipPath &&
                  e.clipPath.use &&
                  void 0 !== r[s].transform.clip)
              ) {
                var n =
                  "rectangle" === e.clipPath.type
                    ? 100 - parseInt(r[s].transform.clip)
                    : 100 - Math.min(100, 2 * parseInt(r[s].transform.clip));
                switch (e.clipPath.origin) {
                  ...
                  case "r":
                    (e[s + "_mask"] = "u:t;x:" + n + "%;y:0px;"),
                      (r[s].transform.x = i.revToResp("-" + n + "%", i[t].rle));
                    break;
                  case "crl":
                  case "lb":
                  case "lt":
                  ...
                  case "t":
                    (e[s + "_mask"] = "u:t;y:-" + n + "%;y:0px;"),
                      (r[s].transform.y = i.revToResp(n + "%", i[t].rle));
                    break;
                  case "b":
                    (e[s + "_mask"] = "u:t;y:" + n + "%;y:0px;"),
                      (r[s].transform.y = i.revToResp("-" + n + "%", i[t].rle));
                }
                delete r[s].transform.clip,
                  delete r[s].transform.clipB,
                  (e.maskinuse = !0);
              }
              e[s + "_mask"] && (r[s].mask = b(e[s + "_mask"], t).transform),
                null != r[s].mask && r[s].mask.use
                  ? ((r[s].mask.x = void 0 === r[s].mask.x ? 0 : r[s].mask.x),
                    (r[s].mask.y = void 0 === r[s].mask.y ? 0 : r[s].mask.y),
                    delete r[s].mask.use,
                    (r[s].mask.overflow = "hidden"))
                  : (r[s].mask = { ease: "default", overflow: "visible" }),
                e[s + "_chars"] &&
                  (r[s].chars = b(
                    e[s + "_chars"],
                    t,
                ...
                r[s].transform.auto &&
                  ((r[s].transform = jQuery.extend(
                    !0,
                    {},
                    r.frame_0.transform
                  )),
                  (r[s].transform.opacity =
                    void 0 === r[s].transform.opacity
                      ? 0
                      : r[s].transform.opacity),
                  void 0 !== r.frame_0.filter &&
                    (r[s].filter = jQuery.extend(!0, {}, r.frame_0.filter)),
                  void 0 !== r.frame_0.mask &&
                    (r[s].mask = jQuery.extend(!0, {}, r.frame_0.mask)),
                  void 0 !== r.frame_0.chars &&
                    (r[s].chars = jQuery.extend(!0, {}, r.frame_0.chars)),
                  void 0 !== r.frame_0.words &&
                    (r[s].words = jQuery.extend(!0, {}, r.frame_0.words)),
                  void 0 !== r.frame_0.lines &&
                    (r[s].lines = jQuery.extend(!0, {}, r.frame_0.lines))),
                e[s + "_sfx"] &&
                  (r[s].sfx = b(e[s + "_sfx"], t, !1, void 0, "sfx").transform),
                e[s + "_reverse"] &&
                  (r[s].reverse = b(
                    e[s + "_reverse"],
                    t,
        ...
        (e.resetfilter = !1),
        r))
          void 0 !== r[a].filter && (e.resetfilter = !0);
        return (
          e.resetfilter &&
      ...
      _ = function (e) {
        ...
        for (var a in e)
          if (e.hasOwnProperty(a) && "loop" !== a && "frame_hover" !== a) {
            ...
            for (var o = 1; o <= 4; o++)
              for (t in i[r[o]])
                i[r[o]].hasOwnProperty(t) &&
                  ((e[a][r[o]] = void 0 === e[a][r[o]] ? {} : e[a][r[o]]),
                  (i[r[o]][t] =
                    void 0 === e[a][r[o]][t]
                      ? "frame_0" === a
                        ? window.rdF0[r[o]][t]
                      ...
                      : e[a][r[o]][t]),
                  (e[a][r[o]][t] =
                    void 0 === e[a][r[o]][t] ? i[r[o]][t] : e[a][r[o]][t]));
          }
        return e;
      },
      x = function (e, t) {
        ...
        for (
          var i = e[0].getElementsByClassName(t), r = {}, a = 0;
          a < i.length;
          a++
        )
          r[i[a].id] = i[a];
      ...
      k = function (e, t, r) {
        ...
        var a = window.getComputedStyle(e[0], null),
          o =
            void 0 !== e[0].id && void 0 !== i[r]._L[e[0].id]
              ? i[r]._L[e[0].id]
              : e.data(),
          s = "rekursive" === t ? e.closest(".rs-layer") : void 0,
          n =
            void 0 !== s &&
            a.fontSize === s.css("fontSize") &&
            a.fontWeight === s.css("fontWeight") &&
            a.lineHeight === s.css("lineHeight"),
          l = n
            ? void 0 !== s[0].id && void 0 !== i[r]._L[s[0].id]
              ? i[r]._L[s[0].id]
              : s.data()
            : void 0,
          d = 0;
        (o.basealign = void 0 === o.basealign ? "grid" : o.basealign),
          o._isnotext ||
            ...
            void 0 !== o.tshadow &&
              ((o.tshadow.b = i.revToResp(o.tshadow.b, i[r].rle)),
              (o.tshadow.h = i.revToResp(o.tshadow.h, i[r].rle)),
              (o.tshadow.v = i.revToResp(o.tshadow.v, i[r].rle)))),
          void 0 !== o.bshadow &&
            ((o.bshadow.b = i.revToResp(o.bshadow.b, i[r].rle)),
            (o.bshadow.h = i.revToResp(o.bshadow.h, i[r].rle)),
            (o.bshadow.v = i.revToResp(o.bshadow.v, i[r].rle)),
            (o.bshadow.s = i.revToResp(o.bshadow.s, i[r].rle))),
          (o.display = n
            ? void 0 === l.display
              ? s.css("display")
              : l.display
          ...
          (o.paddingTop = i.revToResp(
            void 0 === o.paddingtop
              ? parseInt(a.paddingTop, 0) || 0
              : o.paddingtop,
            i[r].rle
          )),
          (o.paddingBottom = i.revToResp(
            void 0 === o.paddingbottom
              ? parseInt(a.paddingBottom, 0) || 0
              : o.paddingbottom,
            i[r].rle
          )),
          (o.paddingLeft = i.revToResp(
            void 0 === o.paddingleft
              ? parseInt(a.paddingLeft, 0) || 0
              : o.paddingleft,
            i[r].rle
          )),
          (o.paddingRight = i.revToResp(
            void 0 === o.paddingright
              ? parseInt(a.paddingRight, 0) || 0
              : o.paddingright,
            i[r].rle
          )),
          (o.marginTop = i.revToResp(
            void 0 === o.margintop
              ? parseInt(a.marginTop, 0) || 0
              : o.margintop,
            i[r].rle
          )),
          (o.marginBottom = i.revToResp(
            void 0 === o.marginbottom
              ? parseInt(a.marginBottom, 0) || 0
              : o.marginbottom,
            i[r].rle
          )),
          (o.marginLeft = i.revToResp(
            void 0 === o.marginleft
              ? parseInt(a.marginLeft, 0) || 0
              : o.marginleft,
            i[r].rle
          )),
          (o.marginRight = i.revToResp(
            void 0 === o.marginright
              ? parseInt(a.marginRight, 0) || 0
              : o.marginright,
            i[r].rle
          )),
          (o.borderTopWidth =
            void 0 === o.borderwidth
              ? parseInt(a.borderTopWidth, 0) || 0
              : o.borderwidth[0]),
          (o.borderBottomWidth =
            void 0 === o.borderwidth
              ? parseInt(a.borderBottomWidth, 0) || 0
              : o.borderwidth[2]),
          (o.borderLeftWidth =
            void 0 === o.borderwidth
              ? parseInt(a.borderLeftWidth, 0) || 0
              : o.borderwidth[3]),
          (o.borderRightWidth =
            void 0 === o.borderwidth
              ? parseInt(a.borderRightWidth, 0) || 0
              : o.borderwidth[1]),
          ...
          (o.borderStyle = i.revToResp(
            void 0 === o.borderstyle ? a.borderStyle || 0 : o.borderstyle,
            i[r].rle
          )),
          (o.borderBottomColor =
            void 0 === o.bordercolor
              ...
              : o.bordercolor),
          (o.borderTopColor =
            void 0 === o.bordercolor ? a["border-top-color"] : o.bordercolor),
          (o.borderLeftColor =
            void 0 === o.bordercolor ? a["border-left-color"] : o.bordercolor),
          (o.borderRightColor =
            void 0 === o.bordercolor ? a["border-right-color"] : o.bordercolor),
          "rekursive" !== t
            ? ((o.color = i.revToResp(
              ...
              (o.minWidth = i.revToResp(
                void 0 === o.minwidth
                  ? parseInt(a.minWidth, 0) || 0
                  : o.minwidth,
                i[r].rle
              )),
              (o.minHeight = i.revToResp(
                void 0 === o.minheight
                  ? parseInt(a.minHeight, 0) || 0
                  : o.minheight,
                i[r].rle
              )),
              (o.width = i.revToResp(
              ...
              (o.maxHeight = i.revToResp(
                -1 !== jQuery.inArray(o.type, ["column", "row"])
                  ? "none"
                  : void 0 !== o.maxheight
                  ? parseInt(a.maxHeight, 0) || "none"
                  : o.maxheight,
                i[r].rle
              )))
            : "html" === o.layertype &&
              ((o.width = i.revToResp(e[0].width, i[r].rle)),
              (o.height = i.revToResp(e[0].height, i[r].rle))),
          (o.styleProps = {
          ...
          "" == o.styleProps.color && (o.styleProps.color = a.color);
      },
      T = function (e, t) {
        if (void 0 !== e) {
          ...
          var r = i[t].level,
            ...
            o = {
              basealign:
                void 0 ===
                (a = void 0 === a.basealign ? e.closest("rs-layer").data() : a)
                  .basealign
                  ? "grid"
                  : a.basealign,
              lineHeight:
                void 0 === a.basealign ? "inherit" : parseInt(a.lineHeight[r]),
          ...
          return (
            (o.borderTopColor = a.borderTopColor),
            (o.borderBottomColor = a.borderBottomColor),
            (o.borderLeftColor = a.borderLeftColor),
            (o.borderRightColor = a.borderRightColor),
            a._isnotext ||
              ((o.textDecoration = a.textDecoration),
              (o.fontSize = parseInt(a.fontSize[r])),
              (o.fontWeight = parseInt(a.fontWeight[r])),
              (o.letterSpacing = parseInt(a.letterSpacing[r]) || 0),
              (o.textAlign = a.textAlign[r]),
              (o.whiteSpace = a.whiteSpace[r]),
              (o.whiteSpace =
                "normal" === o.whiteSpace &&
                "auto" === o.width &&
                !0 !== a._incolumn
              ...
              void 0 !== a.tshadow &&
                (o.textShadow =
                  parseInt(a.tshadow.h[r], 0) +
                  "px " +
                  parseInt(a.tshadow.v[r], 0) +
                  "px " +
                  a.tshadow.b[r] +
                  " " +
                  a.tshadow.c),
              void 0 !== a.tstroke &&
                (o.textStroke =
                  parseInt(a.tstroke.w, 0) + "px " + a.tstroke.c)),
            void 0 !== a.bshadow &&
              (o.boxShadow =
                parseInt(a.bshadow.h[r], 0) +
                "px " +
                parseInt(a.bshadow.v[r], 0) +
                "px " +
                parseInt(a.bshadow.b[r], 0) +
                "px " +
                parseInt(a.bshadow.s[r], 0) +
                "px " +
                a.bshadow.c),
            o
          );
  ...
  (function (e) {
    ...
    function r(e, i) {
      ...
      return (
        (r.mask = r.c.find(".tp-" + i + "-mask")),
        (r.wrap = r.c.find(".tp-" + i + "s-inner-wrapper")),
        r
      );
    }
    jQuery.extend(!0, t, {
      hideUnHideNav: function (e) {
        ...
        p(r) && k(t[e].c.find(".tparrows"), r.hide_under, i, r.hide_over),
          p(a) && k(t[e].c.find(".tp-bullets"), a.hide_under, i, a.hide_over),
        ...
        if (
          ...
          if (
            ...
            p(s) &&
              ...
              o(r, a, t[e].c, s, t[e].slideamount, "tab"),
            p(n) &&
              (i || n.width > n.min_width) &&
              o(r, a, t[e].c, n, t[e].slideamount, "thumb"),
            p(l) && i)
          ) {
            ...
            d.find(".tp-bullet").each(function (e) {
              ...
              "vertical" === l.direction
                ? (t.css({ top: (i - 1) * a + "px", left: "0px" }),
                  d.css({
                    height: (i - 1) * a + t.outerHeight(),
                    width: t.outerWidth(),
                  }))
                : (t.css({ left: (i - 1) * r + "px", top: "0px" }),
                  d.css({
            ...
            ("fullscreen" != t[e].sliderLayout &&
              ...
              (t[e].navigation.bullets.h_offset =
                "center" === t[e].navigation.bullets.h_align
                  ? t[e].navigation.bullets.h_offset_old + r / 2 - o / 2
                  : t[e].navigation.bullets.h_offset_old + r - o)),
              ...
              ("fullscreen" != t[e].sliderLayout &&
                ...
                (t[e].navigation.arrows.left.h_offset =
                  "right" === t[e].navigation.arrows.left.h_align
                    ...
                    : t[e].navigation.arrows.left.h_offset_old + r),
                ...
                (t[e].navigation.arrows.right.h_offset =
                  "right" === t[e].navigation.arrows.right.h_align
                    ...
                    : t[e].navigation.arrows.right.h_offset_old + r)),
              b(
      ...
      createNavigation: function (e) {
        ...
        s(e),
          ...
          x && jQuery.extend(!0, f, r(e, "thumb")),
          k && jQuery.extend(!0, v, r(e, "tab")),
          t[e].c.bind(
            ...
            function (i) {
              if (
                ...
                var r =
                  void 0 === t[e].pr_next_key
                    ? t.gA(t[e].slides[t[e].pr_active_key], "key")
                    : t.gA(t[e].slides[t[e].pr_next_key], "key");
                t[e].c.find(".tp-bullet").each(function () {
                  ...
                  t[e].cpar.find(".tp-thumb, .tp-tab").each(function () {
                    t.gA(this, "key") === r
                      ? (this.classList.add("selected"),
                        "RS-TAB" === this.nodeName ? a(v, e) : a(f, e))
                      : this.classList.remove("selected");
                  });
                var s = 0,
                  n = !1;
          ...
          c(f),
          c(v),
          t[e].cpar.on("mouseenter mousemove", function (r) {
    ...
    var a = function (e, i) {
        ...
        s > 2 &&
          ((c = l - (p + r) <= 0 ? (l - (p + r) < 0 - r ? p : c + r) : c),
          (c =
            l - r + p + a < r && l + (Math.round(s) - 2) * r < p
              ? l + (Math.round(s) - 2) * r
              : c)),
          (c =
              ...
              "vertical" === r.direction
                ? t.add(
                    punchgs.TweenLite.set(i, {
                      top:
                        e * (c + parseInt(void 0 === r.space ? 0 : r.space, 0)),
                      width: d + "px",
                      height: c + "px",
                    })
                  )
                : "horizontal" === r.direction &&
                  t.add(
                    punchgs.TweenLite.set(i, {
                      left:
                        e * (d + parseInt(void 0 === r.space ? 0 : r.space, 0)),
                      width: d + "px",
                      height: c + "px",
                    })
                  );
      ...
      l = function (e, t, r) {
        return !0 ===
          (e = i
            ? jQuery(r.target).closest(e).length ||
              jQuery(r.srcElement).closest(e).length
            : jQuery(r.toElement).closest(e).length ||
              jQuery(r.originalTarget).closest(e).length) || 1 === e
          ? 1
          : 0;
      },
      d = function (e, r, a) {
        ...
        var s = e,
          n =
            "vertical" === t[r].navigation.thumbnails.direction ||
            "vertical" === t[r].navigation.tabs.direction
              ? "none"
              : "vertical",
          d = t[r].navigation.touch.swipe_direction || "horizontal";
        (n =
          "swipebased" == a && "vertical" == d ? "none" : a ? "vertical" : n),
          ...
          s.swipetp({
            ...
            fingers:
              t[r].navigation.touch.swipe_min_touches > 5
                ? 1
                : t[r].navigation.touch.swipe_min_touches,
            ...
            swipeStatus: function (a, s, n, c, p, u, h) {
              ...
              if (
                "carousel" === t[r].sliderType &&
                ((("move" === s || "end" === s || "cancel" == s) &&
                  t[r].dragStartedOverSlider &&
                  !t[r].dragStartedOverThumbs &&
                  !t[r].dragStartedOverTabs) ||
                  ("start" === s && g > 0 && 0 === f && 0 === m))
              ) {
                if (i && ("up" === n || "down" === n)) return;
                switch (
                  (void 0 !== o.positionanim && o.positionanim.pause(),
                  (t[r].dragStartedOverSlider = !0),
                  (c =
                    n && n.match(/left|up/g)
                      ? Math.round(-1 * c)
                      : (c = Math.round(1 * c))),
                  ...
                  case "move":
                    if (Math.abs(c) >= 10 || t[r].carousel.isDragged) {
                      if (
                        ...
                        !(y < 0 || y > t[r].slideamount - 1)
                          ? y >= 0 &&
                            y <= t[r].slideamount - 1 &&
                            ((y >= 0 && c > o.overpull) ||
                              (y <= t[r].slideamount - 1 && c < o.overpull)) &&
                            (o.overpull = 0)
                          : (o.overpull = c),
                          (o.slide_offset =
                            y < 0
                  ...
                  case "end":
                  case "cancel":
                    (t[r].carousel.isDragged = !1),
                      (o.slide_globaloffset = o.slide_offset),
                      o.wrap.removeClass("dragged"),
                      t.carouselToEvalPosition(r, n),
                      (t[r].dragStartedOverSlider = !1),
                      (t[r].dragStartedOverThumbs = !1),
                      (t[r].dragStartedOverTabs = !1),
                      setTimeout(function () {
                        t[r].c
                          .find(".rs-waction")
                ...
                if (
                  ...
                  if ("end" == s && !v) {
                    if (
                      ((t[r].sc_indicator = "arrow"),
                      ("horizontal" == d && "left" == n) ||
                        ("vertical" == d && "up" == n))
                    )
                      return (
                        (t[r].sc_indicator_dir = 0), t.callingNewSlide(r, 1), !1
                      );
                    if (
                      ...
                      return (
                        (t[r].sc_indicator_dir = 1),
                        t.callingNewSlide(r, -1),
                        !1
                      );
                  }
                  return (
                ...
                f > 0 && (t[r].dragStartedOverThumbs = !0),
                  m > 0 && (t[r].dragStartedOverTabs = !0);
                var b = t[r].dragStartedOverThumbs ? ".tp-thumbs" : ".tp-tabs",
                  w = t[r].dragStartedOverThumbs
                    ? ".tp-thumb-mask"
                    : ".tp-tab-mask",
                  _ = t[r].dragStartedOverThumbs
                    ? ".tp-thumbs-inner-wrapper"
                    : ".tp-tabs-inner-wrapper",
                  x = t[r].dragStartedOverThumbs ? ".tp-thumb" : ".tp-tab",
                  k = t[r].dragStartedOverThumbs
                    ? t[r].navigation.thumbnails
                    : t[r].navigation.tabs;
                c =
                  n && n.match(/left|up/g)
                    ? Math.round(-1 * c)
      ...
      h = function (e) {
        ...
        for (var r in i)
          i.hasOwnProperty(r) &&
            p(t[e].navigation[i[r]]) &&
            (u(t[e].navigation[i[r]].showCall),
            (t[e].navigation[i[r]].showCall = setTimeout(
              function (i) {
                u(i.hideCall),
                  (i.hide_onleave && !t[e].cpar.hasClass("tp-mouseover")) ||
                    (void 0 === i.tween ? (i.tween = f(i)) : i.tween.play());
              },
              t[e].navigation[i[r]].hide_onleave &&
                !t[e].cpar.hasClass("tp-mouseover")
                ? 0
                : parseInt(t[e].navigation[i[r]].animDelay),
              t[e].navigation[i[r]]
            )));
      },
      g = function (e, r) {
        ...
        for (var o in a)
          a.hasOwnProperty(o) &&
            void 0 !== t[e].navigation[a[o]] &&
            t[e].navigation[a[o]].hide_onleave &&
            p(t[e].navigation[a[o]]) &&
            (u(t[e].navigation[a[o]].hideCall),
            (t[e].navigation[a[o]].hideCall = setTimeout(
              function (e) {
                u(e.showCall), e.tween && e.tween.reverse();
              },
              i
                ? parseInt(t[e].navigation[a[o]].hide_delay_mobile, 0)
                : parseInt(t[e].navigation[a[o]].hide_delay, 0),
              t[e].navigation[a[o]]
            )));
      },
      f = function (e) {
        ...
        var a = e.outerHeight(!0),
          ...
          s =
            "layergrid" == i.container
              ? "fullscreen" == t[r].sliderLayout
                ? t[r].height / 2 - (t[r].gridheight[t[r].level] * t[r].bh) / 2
                : t[r].autoHeight ||
                  (null != t[r].minHeight && t[r].minHeight > 0)
                ? o / 2 - (t[r].gridheight[t[r].level] * t[r].bh) / 2
                : 0
              : 0,
          n =
            "top" === i.v_align
              ...
              : "center" === i.v_align
              ? { top: "50%", y: Math.round(0 - a / 2 + i.v_offset) + "px" }
              : { top: "100%", y: Math.round(0 - (a + i.v_offset + s)) + "px" };
      ...
      y = function (e, i, r) {
        var a = e.outerWidth(!0),
          o =
            "layergrid" === i.container
              ? t[r].width / 2 - (t[r].gridwidth[t[r].level] * t[r].bw) / 2
              : 0,
          s =
            "left" === i.h_align
              ? { left: "0px", x: Math.round(i.h_offset + o) + "px" }
              : "center" === i.h_align
              ? { left: "50%", x: Math.round(0 - a / 2 + i.h_offset) + "px" }
              : {
                  left: "100%",
      ...
      w = function (e, i, r, a) {
        ...
        var o = e.find(".tp-bullets"),
          s = r.data("key"),
          n = i.tmp;
        void 0 !== t[a].thumbs[r.index()] &&
          jQuery.each(t[a].thumbs[r.index()].params, function (e, t) {
        ...
        "vertical" === i.direction
          ...
          l.click(function () {
            (t[a].sc_indicator = "bullet"),
              e.revcallslidewithid(s),
              e.find(".tp-bullet").removeClass("selected"),
              jQuery(this).addClass("selected");
          }),
          l.removeClass("justaddedbullet"),
          (i.padding_top = parseInt(t[a].carousel.padding_top || 0, 0)),
          (i.padding_bottom = parseInt(t[a].carousel.padding_bottom || 0, 0)),
      ...
      _ = function (e, i, r, a, o) {
        ...
        var h = r.data("key"),
          ...
          w = i.tmp;
        void 0 !== t[o].thumbs[r.index()] &&
          jQuery.each(t[o].thumbs[r.index()].params, function (e, t) {
      ...
      x = function (e) {
        ...
        (t[e].top_outer = i.hasClass("tp-forcenotvisible")
          ? 0
          : i.outerHeight() || 0),
          (t[e].bottom_outer = r.hasClass("tp-forcenotvisible")
            ? 0
            : r.outerHeight() || 0);
      },
      k = function (e, t, i, r) {
      ...
      startPanZoom: function (e, i, r) {
        ...
        if (void 0 !== a.panzoom && null !== a.panzoom) {
            ...
            h = (function (e, t, i) {
              var r =
                ...
                s = {
                  ...
                  starto: {},
                  end: { rotation: r.rotateend + "deg", scale: r.scaleend },
                  endo: {},
                };
              r.scalestart,
                i.owidth,
              ...
              (a[0] = parseFloat(a[0]) + l.start.l),
                (o[0] = parseFloat(o[0]) + l.end.l),
                (a[1] = parseFloat(a[1]) + l.start.t),
              ...
              var d = l.start.r - l.start.l,
                ...
                h = l.end.b - l.end.t;
              return (
                (a[0] = a[0] > 0 ? 0 : d + a[0] < e ? e - d : a[0]),
                (o[0] = o[0] > 0 ? 0 : u + o[0] < e ? e - u : o[0]),
                (a[1] = a[1] > 0 ? 0 : p + a[1] < t ? t - p : a[1]),
                (o[1] = o[1] > 0 ? 0 : h + o[1] < t ? t - h : o[1]),
                (s.starto.x = a[0] + "px"),
                (s.starto.y = a[1] + "px"),
                (s.endo.x = o[0] + "px"),
                (s.endo.y = o[1] + "px"),
                (s.end.ease = s.endo.ease = r.ease),
          ...
          if (
            ...
            (a.panvalues.duration =
              NaN === a.panvalues.duration || void 0 === a.panvalues.duration
                ? 10
                : a.panvalues.duration),
            g.add(
              punchgs.TweenLite.fromTo(p, a.panvalues.duration, h.start, h.end),
              0
            ),
            g.add(
              punchgs.TweenLite.fromTo(
            ...
            void 0 !== a.panvalues.blurstart &&
              void 0 !== a.panvalues.blurend &&
              (0 !== a.panvalues.blurstart || 0 !== a.panvalues.blurend))
          ) {
            var f = { a: a.panvalues.blurstart },
              m = { a: a.panvalues.blurend, ease: h.endo.ease },
    ...
    jQuery.extend(!0, t, {
      checkForParallax: function (e) {
        ...
        if (!r.done) {
          ...
          if (
            ("3D" == r.type || "3d" == r.type) &&
            (punchgs.TweenLite.set(t[e].c, { overflow: r.ddd_overflow }),
            punchgs.TweenLite.set(t[e].canvas, { overflow: r.ddd_overflow }),
          ...
          for (var o = 1; o <= r.levels.length; o++)
            t[e].c.find(".rs-pxl-" + o).each(function () {
              ...
              t.data("parallaxlevel", r.levels[o - 1]),
                t.addClass("tp-parallax-container"),
                r.pcontainers.push(t),
                r.pcontainer_depths.push(r.levels[o - 1]);
            });
          ("mouse" != r.type &&
            "mousescroll" != r.type &&
            "3D" != r.type &&
            ...
            (t[e].c.mouseenter(function (i) {
              var r = t[e].c.offset().top,
                a = t[e].c.offset().left;
              void 0 !== t[e].pr_active_key &&
                (t.sA(t[e].slides[t[e].pr_active_key], "enterx", i.pageX - a),
                t.sA(t[e].slides[t[e].pr_active_key], "entery", i.pageY - r));
            }),
            t[e].c.on(
              "mousemove.hoverdir, mouseleave.hoverdir, trigger3dpath",
              function (i, a) {
                var o =
                  a && a.li ? a.li : jQuery(t[e].slides[t[e].pr_active_key]);
                if ("enterpoint" == r.origo) {
                  ...
                  (s = t[e].c.offset().top),
                    ...
                    (u = r.speed / 1e3 || 3);
                "mouseleave" == i.type &&
                  ((c = r.ddd_lasth || 0), (p = r.ddd_lastv || 0), (u = 1.5));
                  ...
                  "carousel" === t[e].sliderType &&
                    ...
                    t[e].c.find(b).each(function () {
                      ...
                      a.hasClass("dddwrapper-layer") &&
                        ((g = r.ddd_z_correction || 65), (f = !0)),
                        a.hasClass("dddwrapper-layer") && ((s = 0), (n = 0)),
                        h.index() === t[e].pr_active_key ||
                        "carousel" != t[e].sliderType
                          ? !r.ddd_bgfreeze || f
                            ? punchgs.TweenLite.to(a, u, {
                                rotationX: d,
                                rotationY: -l,
                                x: s,
                                z: g,
        ...
        function n(i) {
          if ("3D" == r.type || "3d" == r.type) {
            ...
            i.find(".dddwrapper-layertobggroup").appendTo(a),
              "carousel" == t[e].sliderType &&
                (r.ddd_shadow && a.addClass("dddwrappershadow"),
                punchgs.TweenLite.set(a, {
            ...
            if (l.bgcontainers)
              for (f = 0; f < l.bgcontainers.length; f++) {
                ...
                (y = c * (-l.bgcontainer_depths[f] * t[e].conh) || 0),
                  (b = void 0 !== a ? a : l.speedbg / 1e3 || 0.015);
                (b =
      ...
      r = function (e) {
        ...
        !0 !== e.recall
          ? ((t[r].lastSliderAnimation = jQuery.extend(!0, {}, e.animation)),
            (t[r].lastSliderTransition = jQuery.extend(!0, {}, s)))
        ...
        (d =
          (d =
            "default" === d || "d" === d
              ...
              : null != d
              ? parseInt(d, 0)
              : s.TR[10]) > t[r].duration
            ? t[r].duration
            : d),
          (t[r].rotate = i(e.animation.rotate, l)),
          (t[r].rotate =
            null == t[r].rotate ||
            "default" == t[r].rotate ||
            "d" == t[r].rotate
          ...
          (n < 11 ||
            ...
            18 === n ||
            (s.nTR >= 27 && s.nTR <= 30)) &&
            ((t[r].slots = i(e.animation.slotamount, l)),
            (t[r].slots =
            ...
            (t[r].slots =
              t[r].slots < 1
                ...
                : t[r].slots),
            (t[r].slots =
              (4 == n || 5 == n || 6 == n) && t[r].slots < 3 ? 3 : t[r].slots),
            (t[r].slots =
              0 != s.TR[3] ? Math.min(t[r].slots, s.TR[3]) : t[r].slots),
            (t[r].slots =
              9 == n
                ? t[r].width / t[r].slots
                : 10 == n
                ? t[r].height / t[r].slots
                : t[r].slots),
            (t[r].slots =
            ...
            (t[r].slots =
              (3 != n && 8 != n && 10 != n) || "vertical" !== s.TR[4]
                ? t[r].slots
                : t[r].slots + 2),
            null != s.TR[6] && a(t[r].pr_active_bg, r, s.TR[6], s.TR[4]),
            null != s.TR[5] && a(t[r].pr_next_bg, r, s.TR[5], s.TR[4]),
            t[r].mtl.delay(0.075));
        var c = 7 === n || 16 === n || 8 === n || 17 === n || 18 === n ? 0 : 1,
          p = n < 11 || 17 === n || 18 === n ? 0 : 1;
        t[r].mtl.add(
          punchgs.TweenLite.set(t[r].pr_active_bg.find("rs-sbg"), {
            scale: 1,
            rotationX: 0,
            rotationY: 0,
            rotationZ: 0,
          ...
          t[r].mtl.add(
            punchgs.TweenLite.set(t[r].pr_next_bg.find("rs-sbg"), {
              scale: 1,
              rotationX: 0,
              rotationY: 0,
              rotationZ: 0,
          ...
          t[r].mtl.add(
            punchgs.TweenLite.set(t[r].pr_next_bg, {
          ...
          t[r].mtl.add(
            punchgs.TweenLite.set(t[r].pr_active_bg, {
              transformOrigin: "50% 50% 0",
              transformPerspective: 600,
              scale: 1,
              rotationX: 0,
          ...
          t[r].mtl.add(
            punchgs.TweenLite.set(t[r].pr_next_bg.parent(), {
              backgroundColor: "transparent",
            }),
            0
          ),
          t[r].mtl.add(
            punchgs.TweenLite.set(t[r].pr_active_bg.parent(), {
              backgroundColor: "transparent",
            }),
            0
          );
        ...
        if (
          ...
          t[r].pr_next_bg.find(".slotslide").each(function (e) {
            (f = ++f === g ? 0 : f),
              (t[r].rotate = 1 === s.trC ? 45 : t[r].rotate),
              t[r].mtl.add(
          ...
          for (
            var y = t[r].pr_next_bg[0].getElementsByClassName("slotslide"),
              b = d - d / 1.8,
              w = 0;
            w < y.length;
            w++
          ...
          switch (s.trC) {
            ...
            case 4:
              t[r].mtl.add(
                ...
                t[r].mtl.add(
                  punchgs.TweenLite.to(t[r].pr_active_bg, d / 2e3, {
                    autoAlpha: 0,
                    force3D: "auto",
                    ease: u,
                  }),
          ...
          var T = 3 == s.trC ? d / 1300 : d / 1e3,
            ...
            M = 4 == s.trC || 5 == s.trC ? 0.6 : 6 == s.trC ? 1.4 : 1,
            O = 5 == s.trC ? 1.4 : 6 == s.trC ? 0.6 : 1;
          if (
            ((7 != s.trC && 4 != s.trC) || ((R = 0), (I = 0)),
            8 == s.trC
              ? (t[r].mtl.add(
                  punchgs.TweenLite.set(t[r].pr_active_slide, { zIndex: 20 }),
                  0
                ),
                t[r].mtl.add(
                  punchgs.TweenLite.set(t[r].pr_next_slide, { zIndex: 15 }),
                  0
                ),
                t[r].mtl.add(
                  punchgs.TweenLite.to(t[r].pr_next_bg, 0.01, {
                    overflow: "hidden",
                    left: 0,
                    top: 0,
                    x: 0,
              ...
              : (t[r].mtl.add(
                  punchgs.TweenLite.set(t[r].pr_active_slide, { zIndex: 15 }),
                  0
                ),
                t[r].mtl.add(
                  punchgs.TweenLite.set(t[r].pr_next_slide, { zIndex: 20 }),
                  0
                ),
                t[r].mtl.add(
                  punchgs.TweenLite.from(t[r].pr_next_bg, T, {
                    left: A,
                    top: z,
                    overflow: "hidden",
                    scale: O,
            ...
            switch (n) {
              case 12:
                t[r].mtl.add(
                  punchgs.TweenLite.to(t[r].pr_active_bg, L, {
                    left: 0 - R + "px",
                    overflow: "hidden",
                    force3D: "auto",
                    scale: M,
          ...
          t[r].mtl.add(
            ...
            t[r].mtl.add(
              punchgs.TweenLite.set(t[r].pr_next_slide, { zIndex: 10 }),
              0
            );
          C =
            19 === n
              ? "center center -" + t[r].height / 2
              : 22 === n
              ? "center center " + t[r].height / 2
              : 23 === n
              ? "center center -" + t[r].width / 2
              : "center center " + t[r].width / 2;
          punchgs.TweenLite.set(t[r].c, {
            ...
            (22 !== n && 24 !== n) ||
              t[r].mtl.add(
                punchgs.TweenLite.fromTo(
                  [t[r].pr_active_bg, t[r].pr_next_bg],
                  d / 2e3,
                  { z: -200 },
          ...
          (d = 0),
            ...
            t[r].mtl.add(
              punchgs.TweenLite.to(t[r].pr_active_bg, 0.001, {
                autoAlpha: 0,
                force3D: "auto",
                ease: u,
              }),
          ...
          var Q = t[r].pr_next_bg.find(".slot"),
            ...
            W = 27 == n || 29 == n ? "+10%" : "-10%",
            V = { overwrite: "all" },
            Y = { autoAlpha: 0, zIndex: 1, force3D: "auto", ease: u },
            F = {
              position: "inherit",
              autoAlpha: 0,
              overwrite: "all",
            ...
            E = { autoAlpha: 1, force3D: "auto", ease: h },
            X = { overwrite: "all", zIndex: 2, opacity: 1, autoAlpha: 1 },
          ...
          (V[G] = "0px"),
            ...
            t[r].mtl.add(
              punchgs.TweenLite.fromTo(t[r].pr_active_bg, d / 1e3, V, Y),
              0
            ),
            t[r].mtl.add(
              punchgs.TweenLite.fromTo(
            ...
            t[r].mtl.add(punchgs.TweenLite.fromTo(Q, d / 1e3, X, Z), 0),
            t[r].mtl.add(
  ...
  (function (e) {
    ...
    jQuery.extend(!0, t, {
        ...
        (t[i].videos = void 0 === t[i].videos ? {} : t[i].videos),
          e.find(".rs-layer-audio").each(function () {
            ...
            0 === e.find("audio").length &&
              ...
              (a.status = "prepared"),
              (a.start = jQuery.now()),
              (a.waittime = void 0 !== r.ploadwait ? 1e3 * r.ploadwait : 5e3),
              ("auto" != a.pre &&
                "canplaythrough" != a.pre &&
                "canplay" != a.pre &&
                "progress" != a.pre) ||
                (void 0 === t[i].audioqueue && (t[i].audioqueue = []),
                t[i].audioqueue.push(a),
        ...
        switch (o.type) {
          ...
          case "vimeo":
            o.volcachecheck ||
              ...
              (o.volcachecheck = !0)),
              (o.volume = !0 === r ? "mute" : !1 === r ? o.volcache : o.volume),
              void 0 !== r &&
                null != o.vimeoplayer &&
                n(o, !0 === r ? 0 : o.volcache),
              (a = "mute" == o.volume || 0 === o.volume);
            break;
          case "html5":
            o.volcachecheck ||
              ((o.volcache = o.volcache > 1 ? o.volcache / 100 : o.volcache),
              ...
              void 0 !== r && o.video && (o.video.muted = r),
              (a = void 0 !== o.video ? o.video.muted : a);
        }
        ...
        switch ((clearTimeout(r.videoplaywait), r.type)) {
          case "youtube":
            if (0 == e.find("iframe").length)
              e.append(r.videomarkup), h(e, i, !0);
            else if (null != r.player.playVideo) {
              var o = r.player.getCurrentTime();
              r.nseTriggered && ((o = -1), (r.nseTriggered = !1)),
                -1 != r.ssec && r.ssec > o && r.player.seekTo(r.ssec),
                !0 !== r.youtubepausecalled && p(r);
            } else
          ...
          case "vimeo":
            0 == e.find("iframe").length
              ? (delete r.vimeoplayer, e.append(r.videomarkup), h(e, i, !0))
              ...
              ? ((r.vimeoplayer =
                ...
                r.vimeoplayer.getPaused()
                  ? setTimeout(function () {
                      ...
                      r.nseTriggered && ((a = -1), (r.nseTriggered = !1)),
                        -1 != r.ssec &&
                          r.ssec > a &&
                        ...
                        ("mute" == r.volume ||
                          ...
                          !0 === t[i].globalmute) &&
                          ((r.volumetoken = !0), r.vimeoplayer.setVolume(0)),
                        c(r.vimeoplayer);
                    }, 510)
                  : (r.videoplaywait = setTimeout(function () {
          ...
          case "html5":
            if (r.metaloaded) {
              ...
              r.nseTriggered && ((o = -1), (r.nseTriggered = !1)),
                -1 != r.ssec && r.ssec > o && (r.video.currentTime = r.ssec);
            } else
              a(
                r.video,
                "loadedmetadata",
      ...
      prepareCoveredVideo: function (e, i) {
        ...
        if (
          ...
          void 0 === r.vimeoid || void 0 !== r.vimeoplayerloaded)
        ) {
          if (
            ((r.ifr = i.find("iframe, video")),
            (r.vd =
            ...
            return (
              t.setSize(e),
              clearTimeout(r.resizelistener),
              void (r.resizelistener = setTimeout(function () {
          ...
          "html5" === r.type &&
            ...
            r.ifr.hasClass("resizelistener") ||
              (r.ifr.addClass("resizelistener"),
              jQuery(window).resize(function () {
                t.prepareCoveredVideo(e, i),
                  clearTimeout(r.resizelistener),
                  (r.resizelistener = setTimeout(function () {
                    t.prepareCoveredVideo(e, i);
                  }, 90));
              }));
        }
      ...
      manageVideoLayer: function (e, r) {
        ...
        var o = (t[r].videos[e[0].id] =
          void 0 === t[r].videos[e[0].id] ? y(e.data()) : t[r].videos[e[0].id]);
        if (((o.audio = void 0 !== o.audio && o.audio), i && o.opom))
          ...
          if (!(null != o.poster && o.poster.length > 2) || (i && o.npom)) {
            ...
            0 != e.find("iframe").length ||
              ...
              (delete o.vimeoplayer, e.append(o.videomarkup), h(e, r, !1));
          } else
            0 == e.find("rs-poster").length &&
              e.append(
                '<rs-poster class="noSwipe" style="background-image:url(' +
    ...
    var a = function (e, t, i) {
      ...
      s = function (e, i) {
        var r = t[e].videos[i[0].id];
        (r.bgvideo || r.fcover) &&
          (r.fcover && i.removeClass("rs-fsv").addClass("coverscreenvideo"),
          (void 0 === r.ratio || r.ratio.split(":").length <= 1) &&
            (r.ratio = "16:9"),
          t.prepareCoveredVideo(e, i));
      },
      n = function (e, t) {
                    ...
                    i.data == YT.PlayerState.PLAYING
                      ...
                      : (0 == i.data &&
                        ...
                        -1 != i.data &&
                          ...
                          (t[r].tonpause = !1),
                          w(e, r),
                          t[r].c.trigger("starttimer"),
                          t[r].c.trigger(
                            "revolution.slide.onvideostop",
                            o(n.player, "youtube", n)
                          ),
                          (null != t[r].videoIsPlaying &&
                            t[r].videoIsPlaying.attr("id") != e.attr("id")) ||
                  ...
                  onReady: function (r) {
                    ...
                    (!o && (!t.isSafari11() || (o && s))) ||
                      ...
                      (null == n.speed && 1 === n.speed) ||
                        r.target.setPlaybackRate(parseFloat(n.speed)),
            ...
            case "vimeo":
              ...
              n.vimeoplayer.on("play", function (t) {
                ...
                n.vimeoplayer.on("timeupdate", function (i) {
                  n.vimeostarted || u(n, e, r),
                    n.pausetimer &&
                      "playing" == t[r].sliderstatus &&
                      ((t[r].stopByVideo = !0), t[r].c.trigger("stoptimer")),
                ...
                n.vimeoplayer.on("ended", function (i) {
                  (n.vimeostarted = !1),
                    ...
                    n.nse && ((n.nseTriggered = !0), t[r].c.revnext()),
                    (null != t[r].videoIsPlaying &&
                      t[r].videoIsPlaying.attr("id") != e.attr("id")) ||
                      t.unToggleState(n.videotoggledby);
                }),
        ...
        (n.metaloaded = !0),
            ...
            (n.fcover || n.bgvideo
              ? (n.html5vid.addClass("fullcoveredvideo"),
                (void 0 !== n.ratio && 1 != n.ratio.split(":").length) ||
                  (n.ratio = "16:9"),
                t.prepareCoveredVideo(r, e))
              : n.html5vid.addClass("rs-fsv")),
          a(n.video, "canplaythrough", function () {
          ...
          a(n.video, "pause", function (i) {
            !f() &&
              ...
              (t[r].stopByVideo = !1),
              w(e, r),
              "audio" != n.tag && t[r].c.trigger("starttimer"),
              t[r].c.trigger(
                "revolution.slide.onvideostop",
                o(n.video, "html5", n)
              ),
          ...
          a(n.video, "ended", function () {
            g(),
              ...
              n.nse &&
                ...
                (1 == !t[r].jcnah &&
                  ((n.nseTriggered = !0), t[r].c.revnext(), (t[r].jcnah = !0)),
                setTimeout(function () {
                  t[r].jcnah = !1;
                }, 1500)),
              e.removeClass("videoisplaying");
      ...
      y = function (e, t) {
        ...
        return (
          void 0 !== e.bgvideo && (a.bgvideo = e.bgvideo),
          void 0 === e.bgvideo ||
            (!1 !== a.fcover && "false" !== a.fcover) ||
            (a.doverlay = "none"),
          a.noInt && (a.controls = !1),
          void 0 !== e.mp4 && (a.mp4 = e.mp4),
          void 0 !== e.videomp4 && (a.mp4 = e.videomp4),
          void 0 !== e.ytid && (a.ytid = e.ytid),
          void 0 !== e.ogv && (a.ogv = e.ogv),
          void 0 !== e.webm && (a.webm = e.webm),
          void 0 !== e.vimeoid && (a.vimeoid = e.vimeoid),
          void 0 !== e.vatr && (a.vatr = e.vatr),
          void 0 !== e.videoattributes && (a.vatr = e.videoattributes),
          void 0 !== e.poster && (a.poster = e.poster),
          (a.aplay = "true" === a.aplay || a.aplay),
          (a.aplay = 1 != e.audio && a.aplay),
          1 === a.bgvideo && (a.volume = "mute"),
          (a.ssec = r(a.start)),
          (a.esec = r(a.end)),
          (a.pausetimer =
            void 0 === a.pausetimer
              ? "loopandnoslidestop" !== a.loopcache
              : a.pausetimer),
          (a.inColumn = e._incolumn),
          (a.audio = e.audio),
          (!0 !== a.loop && "true" !== a.loop) ||
            (!0 !== a.nse && "true" !== a.nse) ||
            (a.loop = !1),
          a
        );
      ...
      b = function (e, i) {
        if (
          ...
          for (var r in ((t[i].lastplayedvideos = jQuery.extend(
            !0,
            [],
            t[i].playingvideos
          )),
          t[i].playingvideos))
            t[i].playingvideos.hasOwnProperty(r) &&
              t.stopVideo(t[i].playingvideos[r], i);
